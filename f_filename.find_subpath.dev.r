...
library(tidyverse)
source("f_filename.find_subpath.source.r")
...
library(tidyverse)
source("f_filename.find_subpath.source.r")
filename = "tblID_gj3_jk.rds"
env.custom$f_filename.find_subpath(filename, input_path = dirname(env.custom$path$source_base_local), print.intermediate = T)
# > env.custom$f_filename.find_subpath(filename, input_path = dirname(env.custom$path$source_base_local), print.intermediate = T)
