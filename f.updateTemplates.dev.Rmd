...
#     #         env1$env.internal$f_filename.ext.createBackup(backup_from_path_filename.ext = filename.ext, .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)
...
#         for (filename.ext in c("default.R", "templates-00env1.minimum.Rmd")) {
#             env1$env.internal$f_filename.ext.createBackup(backup_from_path_filename.ext = paste0("D:/OneDrive/[][Rproject]/Rproject_Rmd/",filename.ext), .backup_to_path="D:/OneDrive/[][Rproject]/-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)
#         }
