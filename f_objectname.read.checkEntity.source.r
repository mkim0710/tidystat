...
f_objectname.read.checkEntity = function(path4read, objectname, ext = "rds", varname4ID = c("ID", "PERSON_ID", "RN_INDI")) {
    ...
    filename.ext = if(file.exists(file.path(path4read, filename.ext))) filename.ext else if(file.exists(file.path(path4read, paste0(filename.ext, ".xz")))) paste0(filename.ext, ".xz") else error(paste0(filename.ext, " does not exist!")) ; 
...
# f_objectname.read.checkEntity(path4read, objectname)
# f_objectname.read.checkEntity(path4read, objectname, varname4ID = "randid")



# > f_objectname.read.checkEntity(path4read, objectname)
# Warning:  getwd() != path4read == "data" 
# objectname = "fhs.index100le10"
...
# > tail(get(objectname))
# # A tibble: 6 × 81
#    randid death angina hospmi mi_fchd anychd stroke   cvd hyperten timeap timemi timemifc timechd timestrk timecvd timedth timehyp  sex1 time1  age1 sysbp1 diabp1 bpmeds1
#     <dbl> <dbl>  <dbl>  <dbl>   <dbl>  <dbl>  <dbl> <dbl>    <dbl>  <dbl>  <dbl>    <dbl>   <dbl>    <dbl>   <dbl>   <dbl>   <dbl> <dbl> <dbl> <dbl>  <dbl>  <dbl>   <dbl>
# 1 9842231     0      0      0       0      0      0     0        0  24     24       24      24       24      24      24      24        1     0    41   132.   85         0
# 2 9869235     0      0      1       1      1      0     1        1  24     16.1     16.1    16.1     24      16.1    24       3.99     1     0    44   138.   87.5       0
# 3 9873741     0      0      0       0      0      0     0        0  24     24       24      24       24      24      24      24        1     0    58   116.   71         0
# 4 9901842     1      0      0       1      1      0     1        1  20.2   20.2     13.6    13.6     20.2    13.6    20.2     0        2     0    63   170   105         0
# 5 9957743     1      0      0       0      0      0     0        1   5.23   5.23     5.23    5.23     5.23    5.23    5.23    0        1     0    56   149    98         1
# 6 9968499     1      0      0       0      0      0     0        0  11.4   11.4     11.4    11.4     11.4    11.4    11.4    11.4      1     0    43   130.   88         0
# # ℹ 58 more variables: cursmoke1 <dbl>, cigpday1 <dbl>, educ1 <dbl>, totchol1 <dbl>, hdlc1 <dbl>, ldlc1 <dbl>, bmi1 <dbl>, glucose1 <dbl>, diabetes1 <dbl>,
...
# Warning messages:
# 1: In f_objectname.read.checkEntity(path4read, objectname) :
#   getwd() != path4read == "data"
# 2: In f_objectname.read.checkEntity(path4read, objectname) :
#   varname for ID not identified.
# 3: In f_objectname.read.checkEntity(path4read, objectname) :
#   varname for ID not identified.
# 4: In f_objectname.read.checkEntity(path4read, objectname) :
#   varname for ID not identified.
# > f_objectname.read.checkEntity(path4read, objectname, varname4ID = "randid")
# Warning:  getwd() != path4read == "data" 
# objectname = "fhs.index100le10"
...
# #   prevchd3 <dbl>, prevmi3 <dbl>, prevstrk3 <dbl>, prevhyp3 <dbl>, index100 <int>
# Warning message:
# In f_objectname.read.checkEntity(path4read, objectname, varname4ID = "randid") :
#   getwd() != path4read == "data"
