...
# > ".Rproj.user/shared" |> list.files(recursive = TRUE) |> dput() ----  
c("notebooks/40C0E44C-f_df.CreateTableOne_byExposure.xlsx.dev/1/E3EEE3A9702e3c18/chunks.json", 
...
out_folder <- "recovered_files"
dir.create(out_folder, showWarnings = FALSE)

# Function to read and recover a source file
recover_source_file <- function(metadata_file, content_file, out_folder) {
  # Read the metadata
...
# Iterate over session files to recover metadata and contents
recovered_files <- lapply(session_files, function(file) {
  if (!grepl("-contents$", file)) {
    ...
    if (file.exists(content_file)) {
      recover_source_file(file, content_file, out_folder)
    }
  }
})
...
# List of 43
#  $ : NULL
#  $ : chr "recovered_files/RStudio.Cloud set up.r"
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/f_session_recover.RsRecovr.r"
#  $ : NULL
#  $ : NULL
#  $ : NULL
#  $ : NULL
...
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/f_df.CreateTableOne_byExposure.xlsx.dev.r"
#  $ : NULL
#  $ : chr "recovered_files/RStudio Server Setup.r"
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/f_df.CreateTableOne_byExposure.xlsx.dev.Rmd"
#  $ : NULL
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/f_df.CreateTableOne_byExposure.xlsx.source.r"
#  $ : NULL
...
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/Rocker set up.r"
#  $ : NULL
#  $ : chr "recovered_files/git stash.r"
#  $ : NULL
#  $ : chr "recovered_files/f_session_recover.dev.r"
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/rstudio-prefs.json"
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_files/f_df.t.tribble_construct.source.r"
#  $ : NULL
#  $ : NULL
