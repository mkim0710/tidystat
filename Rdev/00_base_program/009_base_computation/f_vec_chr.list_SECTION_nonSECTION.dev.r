...
# env1$f$f_file.vec_TABLE_OF_CONTENTS.edit_windows_notepad.or_browseURL("env1$env.internal.source.r", RegEx4heading = "^#{1,1}[^#].*(-{4}|={4}) *$") %>% dput
...
input_vec_chr.SECTION_extracted = 
    c("##HHHHHHHHHHHHHHHHHH BEGINNING OF TABLE OF CONTENTS HHHHHHHHHHHHHHHHHHHHHH##  ", 
      ...
      "# ## ::OPTION:: f_file.vec_TABLE_OF_CONTENTS.add_TABLE_OF_CONTENTS       ...1549", 
