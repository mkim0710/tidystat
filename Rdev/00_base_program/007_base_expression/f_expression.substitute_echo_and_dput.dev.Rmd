...
analyticDF_time2event |> str(max.level = 2, give.attr = TRUE)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
quote(dim(get(DataSetName))) |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> quote() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) %>% quote() |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
substitute(dim(get(DataSetName))) |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) %>% substitute() |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
expression(dim(get(DataSetName))) |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> expression() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) %>% expression() |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
parse(text="dim(get(DataSetName))")[[1]] |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
parse(text="dim(get(DataSetName))") |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)} |> str(max.level = 2, give.attr = TRUE)
```
...
dim(get(DataSetName)) |> substitute(list(DataSetName = DataSetName)) |> str(max.level = 2, give.attr = TRUE)
...
dim(get(DataSetName)) |> substitute(as.list(.GlobalEnv)) |> str(max.level = 2, give.attr = TRUE)
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
as.list(.GlobalEnv)[as.list(.GlobalEnv)|>map_lgl(is.character)] |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute(as.list(.GlobalEnv)[as.list(.GlobalEnv)|>map_lgl(is.character)]) 
dim(get(DataSetName)) |> substitute(as.list(.GlobalEnv)[as.list(.GlobalEnv)|>map_lgl(is.character)]) |> str(max.level = 2, give.attr = TRUE)
...
dim(get(DataSetName)) |> substitute(.GlobalEnv.character) |> str(max.level = 2, give.attr = TRUE)
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
dim(get(DataSetName)) |> substitute() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> substitute() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> eval() |> substitute() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> substitute() |> eval() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> substitute() |> eval() |> eval() |> str(max.level = 2, give.attr = TRUE)
dim(get(DataSetName)) |> substitute() |> substitute() |> eval() |> eval() |> substitute() |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> substitute() |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> eval() |> substitute() |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> substitute() |> eval() |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> substitute() |> eval() |> eval() |> str(max.level = 2, give.attr = TRUE)
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} |> substitute() |> eval() |> eval() |> substitute() |> str(max.level = 2, give.attr = TRUE)
```  
...
parse(text=.text_expression) |> str(max.level = 2, give.attr = TRUE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
parse(text="dim(get(DataSetName))")[[1]]
parse(text=.text_expression)[[1]]
parse(text=.text_expression)[[1]] |> str(max.level = 2, give.attr = TRUE)
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
"dim(get(DataSetName))" %>% {parse(text=.)[[1]]} 
.text_expression %>% {parse(text=.)[[1]]} 
.text_expression %>% {parse(text=.)[[1]]} |> str(max.level = 2, give.attr = TRUE)
```
...
dim(get(DataSetName)) |> substitute() |> substitute(list(DataSetName = DataSetName)) |> eval() |> str(max.level = 2, give.attr = TRUE)
...
parse(text=.text_expression)[[1]] |> substitute(list(DataSetName = DataSetName)) |> eval() |> str(max.level = 2, give.attr = TRUE)
...
dim(get(DataSetName)) |> expression() |> substitute() |> str(max.level = 2, give.attr = TRUE)
...
dim(get(DataSetName)) |> expression() |> substitute(list(DataSetName = DataSetName)) |> str(max.level = 2, give.attr = TRUE)
...
dim(get(DataSetName)) |> expression() |> substitute(as.list(.GlobalEnv)[as.list(.GlobalEnv)|>map_lgl(is.character)]) |> str(max.level = 2, give.attr = TRUE)
...
#@@ START) function ----  
## \% |> f_expression.substitute_echo_and_dput 
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)

.text_expression = "dim(get(DataSetName))"
f_expression.substitute_echo_and_dput <- function(text_expression = "", vec_chr_names) {
    str(text_expression)
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
...
f_expression.substitute_echo_and_dput(text_expression = .text_expression)
```
...
### \% as.list(.GlobalEnv)[as.list(.GlobalEnv)|>map_lgl(function(x) is.character(x) && length(x) == 1)]  
### *** \% paste0("(?<![\\w.])",name,"(?![\\w.])")  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
library(purrr)

# Generalized substitute_and_evaluate function
f_expression.substitute_echo_and_dput <- function(expr_text, expression_equals_evaluation = FALSE, .VERBOSE = options()$verbose) {
...
"dim(get(DataSetName))" |> f_expression.substitute_echo_and_dput(.VERBOSE = TRUE)
...
# paste0("https://github.com/mkim0710/",basename(getwd()),"/commints/main/",env1$path$LastSourceEditorContext.path_filename.ext) %>% paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',.,'"') |> system(intern=TRUE)
