...
f_text_function_arguments.identity_mapping = function(input_text) {
...
# Example usage
input_text <- "all.files = TRUE, full.names = TRUE, recursive = FALSE, 
               ignore.case = TRUE, include.dirs = FALSE"
input_text %>% f_text_function_arguments.identity_mapping
