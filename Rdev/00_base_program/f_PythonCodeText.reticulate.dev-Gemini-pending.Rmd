...
# __________|------  
# @@ START) dev ----  
# https://gemini.google.com/app/e02d3c718002045a
...
```{r, echo=FALSE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
for(.packagename in c("reticulate")) {if(!require(.packagename,character.only=TRUE)) install.packages(.packagename)  ;  library(.packagename,character.only=TRUE)}  
```
