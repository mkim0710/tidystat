...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
RegExChrClass34strings_cheatsheet = "[]$*+.?[^{|(\\#%&~_/<=>'!,:;`\")}@-]"
RegExChrClass_strings_cheatsheet %>% dput
RegExChrClass_strings_cheatsheet %>% {cat(" ",.,"\n", sep="")}
# "[]$*+.?[^{|(\\#%&~_/<=>'!,:;`\")}@-]"
#  []$*+.?[^{|(\#%&~_/<=>'!,:;`")}@-]
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
RegExChrClass_strings_cheatsheet_MHsort = "[]$*+.?[^{|(\\#%&~_/<=>'!,:;`\")}@-]"
RegExChrClass_strings_cheatsheet_MHsort %>% dput
RegExChrClass_strings_cheatsheet_MHsort %>% {cat(" ",.,"\n", sep="")}
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
RegExChrClass_gpt_o1 = "[.\\\\+*?^$(){}|\\[\\]\\-]"
