...
f_file.unnest_tokens.count = function(
    ...
    if (isTRUE(VERBOSE)) {
        cat("<VERBOSE> Head of input_vec_chr.df:\n")
        print(head(input_vec_chr.df, 3))
    }
    ...
    if (isTRUE(VERBOSE)) {
        cat("<VERBOSE> Head of input_vec_chr.df.unnest_tokens.count:\n")
        print(head(input_vec_chr.df.unnest_tokens.count, 3))
    }
