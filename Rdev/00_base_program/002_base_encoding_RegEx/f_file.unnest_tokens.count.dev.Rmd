...
options(width=120)
###############################################################################
# Improved Code - f_file.unnest_tokens.count
#
# This function reads an R script from `input_path_file`, optionally removes
# comments, and tokenizes its words. It follows the requested naming conventions,
# provides optional verbose outputs, and returns a tibble with line numbers,
...
f_file.unnest_tokens.count = function(
    ...
    if (isTRUE(VERBOSE_lgl)) {
        cat("[DEBUG] Head of inputChrVec_df:\n")
    ...
    if (isTRUE(VERBOSE_lgl)) {
        ...
        print(head(unnestedTokens_df, 3))
    }
...
#
# Let us demonstrate how to call f_file.unnest_tokens.count on that file below.
...
tidytextTokens_df <- f_file.unnest_tokens.count(
...
stringrTokens_df <- f_file.unnest_tokens.count(
    input_path_file = example_path_file,
    use_tidytext    = FALSE,
    exclude_comments = TRUE,
    VERBOSE_lgl     = FALSE
