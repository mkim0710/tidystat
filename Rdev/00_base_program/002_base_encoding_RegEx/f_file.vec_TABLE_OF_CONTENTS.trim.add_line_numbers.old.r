...
.tmp$objectname = "f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old"
.tmp$object = function(input_path_file = rstudioapi::getSourceEditorContext()$path, level4TOC = 2, RegEx4heading = paste0("^#{1,",level4TOC,"}[^#].*(-{4}|={4}) *$"), remove_lines_with_no_alphabet = TRUE, output_path_file = NULL, replace_input_path_file = FALSE, edit_windows_notepad.or_browseURL = TRUE) {
