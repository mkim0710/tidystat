...
.tmp$objectname = "f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old"
.tmp$object = function(input_path_file = rstudioapi::getSourceEditorContext()$path, level4TOC = 2, RegEx4heading = paste0("^#{1,",level4TOC,"}[^#].*(?:-{4}|={4}) *$"), remove_lines_with_no_alphabet = TRUE, output_path_file = NULL, replace_input_path_file = FALSE, edit_windows_notepad.or_browseURL = !cat2console) {
...
env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old()

# env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old(replace_input_path_file = TRUE)


### env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("env1$env.internal.source.r", RegEx4heading = "^#{1,1}[^#].*(?:-{4}|={4}) *$") ----
env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("env1$env.internal.source.r", RegEx4heading = "^#{1,1}[^#].*(?:-{4}|={4}) *$")
env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("env1$env.internal.source.r", level4TOC = 2, RegEx4heading = paste0("^#{1,",level4TOC,"}[^#].*(?:-{4}|={4}) *$"))

### env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("f_df.t.tribble_construct.source.r", RegEx4heading = "^#{1,1}[^#].*(?:-{4}|={4}) *$") ----
env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("f_df.t.tribble_construct.source.r", RegEx4heading = "^#{1,1}[^#].*(?:-{4}|={4}) *$")
env1$f$f_file.vec_TABLE_OF_CONTENTS.trim.add_line_numbers.old("f_df.t.tribble_construct.source.r", level4TOC = 2, RegEx4heading = paste0("^#{1,",level4TOC,"}[^#].*(?:-{4}|={4}) *$"))
