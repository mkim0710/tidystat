...
f_vec.unescapeRegex_vec <- function(inputVec, VERBOSE = isTRUE(getOption("verbose"))) {
  ...
  # Convert any double quotes into escaped quotes
  escapedStringVec <- gsub("\"", "\\\\\"", inputVec, fixed = TRUE)
  
  # Optional debugging output
  if (VERBOSE) {
    cat("DEBUG: escapedStringVec:\n")
    print(escapedStringVec)
  }
  
  # Use purrr::map_chr for clarity, avoiding tilde or anonymous lambda
