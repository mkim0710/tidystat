...
## @ constant_SpecialChars32KeyboardLayout = ----
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
"`~!@#$%^&*()-=_+
[]\\{}|
...
RegExChrClass4RegExEscape_gpt_o1 = "[$()*+.?[^{|(\\#%&~_/<=>'!,:;`)}@-]"
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
env1$env.internal.attach$f_list_RegExChrClass.union_df(list(RegExChrClass_strings_cheatsheet, RegExChrClass_gpt_o1, RegExChrClass_gpt_o1p, RegExChrClass4RegExEscape_gpt_o1)) %>% as.data.frame
