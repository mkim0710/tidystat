...
#'   \item{union}{Union of the characters from input_str1 and input_str2.}
#'   \item{intersect}{Intersection of the characters.}
#'   \item{setdiff_1_2}{Characters in input_str1 but not in input_str2.}
#'   \item{setdiff_2_1}{Characters in input_str2 but not in input_str1.}
#'
#' @examples
...
#' # a bracketed list, and want to see differences in sets:
