...
f_path_filenameRegEX.rename <- function(path, old_pattern, new_pattern, recursive = FALSE, execute = FALSE) {
  # Get a list of files that match the old pattern, recursively if specified
  old_files <- list.files(path, pattern = old_pattern, full.names = TRUE, recursive = recursive)
