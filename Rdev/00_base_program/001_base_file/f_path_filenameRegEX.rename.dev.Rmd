...
f_path_filenameRegEX.rename <- function(directory, old_pattern, new_pattern, recursive = FALSE, execute = FALSE) {
  # Get a list of files that match the old pattern, recursively if specified
  old_files <- list.files(directory, pattern = old_pattern, full.names = TRUE, recursive = recursive)
  ...
  new_files <- gsub(old_pattern, new_pattern, old_files)
