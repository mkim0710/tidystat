...
#     "{**/*.[Rr],**/*.[Rr].txt,**/*.[Rr][Mm][Dd],default.R,.Rprofile}"
...
# Example usage
# --------------------
inclusion_str  <- "{**/*.[Rr],**/*.[Rr].txt,**/*.[Rr][Mm][Dd],default.R,.Rprofile}"
