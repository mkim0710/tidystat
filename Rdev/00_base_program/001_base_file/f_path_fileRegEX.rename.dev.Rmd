...
if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") {.subpath = env1$path$LastSourceEditorContext.path_file.ext |> dirname(); ".relative.subpath" |> env1$f$f_ObjectName.get.dput.ECHO() }
