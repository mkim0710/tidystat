...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
### env1\$path\$LastSourceEditorContext.path_file.ext ====  
# *** Caution) In Rstudio Notebook, the path of the running Rmd file is set as the working directory~!!!
# env1$path$LastSourceEditorContext.path_file.ext = rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/") |> str_replace(fixed(getwd()|>normalizePath(winslash="/")), "") |> str_replace("^/", "")
env1$path$LastSourceEditorContext.path_file.ext = rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/") |> str_replace(fixed(env1$path$path1|>normalizePath(winslash="/")), "") |> str_replace("^/", "")
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
# .filename.source.r = "f_DataSetName.Search.read.checkEntity" |> paste0(".source.r"); .subpath=r"()"|>str_replace_all("\\\\","/"); .subpath_file.source.r = .filename.source.r %>% paste0(.subpath,ifelse(.subpath=="","","/"),.); if(isTRUE(options()$function.reload) || !.filename.source.r %in% names(.GlobalEnv$env1$source)) {  message('> source("',file.path(env1$path$source_base,.subpath_file.source.r),'")'); .GlobalEnv$env1$source[[.filename.source.r]] = file.path(env1$path$source_base,.subpath_file.source.r); suppressPackageStartupMessages(source(.GlobalEnv$env1$source[[.filename.source.r]]))  }
...
```{r .subpath_file.source.r-NoEchoNoMsgNoResults, echo=FALSE, warning=TRUE, message=NA, results="hide"}
options(width=120)
options(function.reload = TRUE);  # getOption("function.reload")
# .subpath=r"(rstudio-prefs\templates)"|>str_replace_all("\\\\","/")  # Using Raw Strings in R 4.0.0 and Later: The raw string literal, denoted by r"(...)", will not process \ as an escape character.
if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") {.subpath = env1$path$LastSourceEditorContext.path_file.ext |> dirname(); ".subpath" %>% {cat(.,' = "',get(.),'"  \n', sep="")} }
# if(.subpath!="") utils::browseURL(normalizePath(.subpath))
# .filename.source.r = "default.template" |> paste0(".source.r")
if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") {.sourcename_root = env1$path$LastSourceEditorContext.path_file.ext |> basename() |> str_replace("\\.(dev|source)\\.(r|Rmd)$"|>regex(ignore_case=TRUE), "") |> str_replace("\\.(r|Rmd)$"|>regex(ignore_case=TRUE),""); ".sourcename_root" %>% {cat(.,' = "',get(.),'"  \n', sep="")} }
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
env1$path$.subpath_file.dev.r = paste0(.subpath,ifelse(.subpath=="","","/"),.sourcename_root,".dev.r")
env1$path$.subpath_file.dev.Rmd = paste0(.subpath,ifelse(.subpath=="","","/"),.sourcename_root,".dev.Rmd")
env1$path$.subpath_file.source.r = paste0(.subpath,ifelse(.subpath=="","","/"),.sourcename_root,".source.r")
cat("# ",'.sourcename_root = "',.sourcename_root,'"  \n',
    "#### ",env1$path$.subpath_file.dev.r, "----  \n",
    "#### ",env1$path$.subpath_file.dev.Rmd, "----  \n",
    "#### ",env1$path$.subpath_file.source.r, "----  \n",
    '# # source(paste0(env1$path$source_base,"/","',env1$path$.subpath_file.source.r,'"))', "  \n",
    '# # if(!file.exists("',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.r,'")) download.file(url = "https://raw.githubusercontent.com/mkim0710/tidystat/master/rstudio-prefs/templates/default.R", destfile = "',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.r,'")', "  \n",
    '# # if(!file.exists("',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.Rmd,'")) download.file(url = "https://raw.githubusercontent.com/mkim0710/tidystat/master/rstudio-prefs/templates/templates-00env1.minimum.Rmd", destfile = "',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.Rmd,'")', "  \n",
    '# # if(!file.exists("',env1$path$source_base_local,"/",env1$path$.subpath_file.source.r,'")) download.file(url = "https://raw.githubusercontent.com/mkim0710/tidystat/master/rstudio-prefs/templates/default.R", destfile = "',env1$path$source_base_local,"/",env1$path$.subpath_file.source.r,'")', "  \n",
    '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.r,'"); if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_file.ext));', "  \n",
    '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_file.dev.Rmd,'"); if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_file.ext));', "  \n",
    '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_file.source.r,'"); if(!is.null(env1$path$LastSourceEditorContext.path_file.ext)) if(env1$path$LastSourceEditorContext.path_file.ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_file.ext));', "  \n",
    sep="")
# #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
# # \% source( file.path(env1$path$source_base,.subpath_file.source.r) ) ----  
# .subpath_file.source.r = .filename.source.r %>% paste0(.subpath,ifelse(.subpath=="","","/"),.)
# if(isTRUE(options()$function.reload) || !.filename.source.r %in% names(.GlobalEnv$env1$source)) {message('> source("',file.path(env1$path$source_base,.subpath_file.source.r),'")'); .GlobalEnv$env1$source[[.filename.source.r]] = file.path(env1$path$source_base,.subpath_file.source.r); source(.GlobalEnv$env1$source[[.filename.source.r]])}
```
  
  
# __________|------  
# @@ START) function ----  
# https://chatgpt.com/c/6718b61e-2950-800e-aaa3-8b082eec127f
...
# f_path_fileRegEX.rename <- function(path = ".", gsub.pattern_from, gsub.replacement_to, full.names = TRUE, recursive = FALSE, move_to_renamed_path = FALSE, execute = FALSE) {
#     
...
# Example usage:
# Preview the renaming (no changes applied):
# f_path_fileRegEX.rename("path/to/your/directory", "old", "new", recursive = TRUE, execute = FALSE)

# Execute the renaming:
# f_path_fileRegEX.rename("path/to/your/directory", "old", "new", recursive = TRUE, execute = TRUE)

```
  
  
### env1$path$path1 |> f_path_fileRegEX.rename(gsub.pattern_from = "source", gsub.replacement_to = "dev") ----  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
gsub.pattern_from = "source"
gsub.replacement_to = "dev"

env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = FALSE, recursive = FALSE, execute = FALSE)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = FALSE, execute = FALSE)


```
  
  
### env1$path$path1 |> f_path_fileRegEX.rename(gsub.pattern_from = "data", gsub.replacement_to = "DataSet") ----  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
gsub.pattern_from = "data"
gsub.replacement_to = "DataSet"

env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = FALSE, recursive = FALSE, execute = FALSE)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = FALSE, execute = FALSE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = TRUE, execute = FALSE)


```
  
  
### env1$path$path1 |> f_path_fileRegEX.rename(gsub.pattern_from = "labelled", gsub.replacement_to = "lbl") ----  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)

gsub.pattern_from = "labelled"
gsub.replacement_to = "lbl"
...
# env1$path$path1 %>% env1$env.internal.attach$f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = TRUE, execute = TRUE)

```
  
    path == "/home/rstudio/github_tidystat"
    path |> normalizePath() == "/home/rstudio/github_tidystat"
    ...
    path |> normalizePath() == "/home/rstudio/github_tidystat"
      ...
      *** Preview mode: No paths or files have been renamed. ***  
                   [,1]                                                                                                                
    old_path_files "/home/rstudio/github_tidystat/Rdev/10_import_clean_datatype/16_categorical_labelled/f_vec_labelled.as_factor.dev.r"
    new_path_files "/home/rstudio/github_tidystat/Rdev/10_import_clean_datatype/16_categorical_labelled/f_vec_lbl.as_factor.dev.r"     
        ________________________________________________________________________    
    path == "/home/rstudio/github_tidystat"
    path |> normalizePath() == "/home/rstudio/github_tidystat"
    All paths and files renamed successfully.
                                                                                                          old_path_files
    1 /home/rstudio/github_tidystat/Rdev/10_import_clean_datatype/16_categorical_labelled/f_vec_labelled.as_factor.dev.r
                                                                                                     new_path_files renamed
    1 /home/rstudio/github_tidystat/Rdev/10_import_clean_datatype/16_categorical_labelled/f_vec_lbl.as_factor.dev.r    TRUE
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if(exists("MetaData")) {
    ...
    if(!identical(.MetaData0, MetaData)) {
        cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
        .path_file = ifelse(is.null(env1$path$LastSourceEditorContext.path_file.MetaData.rds), NULL, env1$path$LastSourceEditorContext.path_file.MetaData.rds %>% {paste0(env1$path$path1,"/",.)})
...
# #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# .path_file.xlsx = paste0(.path4write,ifelse(.path4write=="","","/"),.objectname,".xlsx")
# openxlsx2::write_xlsx(get(.objectname), file = .path_file.xlsx, as_table = TRUE) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n") 
# if (Sys.info()["sysname"] == "Windows") openxlsx2::xl_open(.path_file.xlsx)
# #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# .path_file.UTF8BOM.csv = paste0(.path4write,ifelse(.path4write=="","","/"),.objectname,".UTF8BOM.csv")
# if (Sys.info()["sysname"] == "Windows") {
#     readr::write_excel_csv(get(.objectname), file = .path_file.UTF8BOM.csv) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
#     openxlsx2::xl_open(.path_file.xlsx)
# } else {
#     readr::write_excel_csv(get(.objectname), file = .path_file.UTF8BOM.csv|>paste0(".xz")) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
# }
# #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# .path_file.UTF8.csv.xz = paste0(.path4write,ifelse(.path4write=="","","/"),.objectname,".UTF8.csv.xz")
# readr::write_csv(get(.objectname), file = .path_file.UTF8.csv.xz) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
```
...
if (Sys.getenv("PARENT_RENDERING") != "YES") {
    # if (Sys.info()["sysname"] == "Windows") {
        env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_file.ext = rstudioapi::getSourceEditorContext()$path|>str_replace("\\.([[:alnum:]]+)$",".Rmd"), .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)
        # env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_file.ext = rstudioapi::getSourceEditorContext()$path|>str_replace("\\.([[:alnum:]]+)$",".nb.html"), .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)
    # }
}
```
...
env1$path$LastSourceEditorContext.path_file.pdf = env1$path$LastSourceEditorContext.path_file.ext |> str_replace("\\.([[:alnum:]]+)$",".pdf") |> str_replace_all('[ <>()|\\:&;#?*\']', "-")
env1$path$LastSourceEditorContext.path_file.html = env1$path$LastSourceEditorContext.path_file.ext |> str_replace("\\.([[:alnum:]]+)$",".html") |> str_replace_all('[ <>()|\\:&;#?*\']', "-")
if (Sys.getenv("PARENT_RENDERING") != "YES") {
    if (Sys.info()["sysname"] == "Windows") {
        ...
        cat('Starting: rstudioapi::getSourceEditorContext()$path |> rmarkdown::render(output_dir = ',deparse(dirname(env1$path$LastSourceEditorContext.path_file.ext)),', output_format = "pdf_document")  \n')
        Sys.setenv(PARENT_RENDERING = "YES"); env1$path$LastSourceEditorContext.path_file.ext %>% {paste0(env1$path$path1,"/",.)} %>% {rmarkdown::render(input = .,output_dir = dirname(.), output_format = "pdf_document")}; Sys.setenv(PARENT_RENDERING = "NO")
        .path_file = env1$path$LastSourceEditorContext.path_file.pdf %>% {paste0(env1$path$path1,"/",.)}
        env1$f$f_file.git_lfs_track_add_f(.path_file = .path_file, Execute = FALSE)
        env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_file.ext = .path_file, .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)
        try(env1$env.internal.attach$f_file_PDF.sumatra(.path_file))
    }
}
# env1$path$LastSourceEditorContext.path_file.ext %>% {paste0(env1$path$path1,"/",.)} %>% {cat('  Sys.setenv(PARENT_RENDERING = "YES"); rmarkdown::render(input = ',deparse(.),', output_dir = ',deparse(dirname(.)),', output_format = "pdf_document"); Sys.setenv(PARENT_RENDERING = "NO")  \n', sep="")}; .path_file = env1$path$LastSourceEditorContext.path_file.pdf %>% {paste0(env1$path$path1,"/",.)}; env1$f$f_file.git_lfs_track_add_f(.path_file = .path_file, Execute = FALSE); cat('  env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_file.ext = ',deparse(.path_file),', .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)  \n', sep=""); if (Sys.info()["sysname"] == "Windows") { cat('  env1$env.internal.attach$f_file_PDF.sumatra(',deparse(.path_file),')  \n', sep="") } else { cat('  browseURL(',deparse(.path_file),')  \n', sep="") }
# cat("    ________________________________________________________________________    \n")
env1$path$LastSourceEditorContext.path_file.ext %>% {paste0(env1$path$path1,"/",.)} %>% {cat('  Sys.setenv(PARENT_RENDERING = "YES"); rmarkdown::render(input = ',deparse(.),', output_dir = ',deparse(dirname(.)),', output_format = "html_document"); Sys.setenv(PARENT_RENDERING = "NO")  \n', sep="")}; .path_file = env1$path$LastSourceEditorContext.path_file.html %>% {paste0(env1$path$path1,"/",.)}; env1$f$f_file.git_lfs_track_add_f(.path_file = .path_file, Execute = FALSE); cat('  env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_file.ext = ',deparse(.path_file),', .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)  \n', sep=""); cat('  env1$env.internal.attach$f_URL.open_in_edge_app(',deparse(.path_file),')  \n', sep="")
```
...
env1$path$LastSourceEditorContext.path_file.nb.html = env1$path$LastSourceEditorContext.path_file.ext |> str_replace("\\.([[:alnum:]]+)$",".nb.html")
if (Sys.info()["sysname"] == "Windows" && Sys.getenv("PARENT_RENDERING") != "YES") { paste0('ping -n 5 127.0.0.1 > nul & "C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',env1$path$LastSourceEditorContext.path_file.nb.html %>% {paste0(env1$path$path1,"/",.)}|>normalizePath(winslash="/"),'"') |> shell(wait=FALSE) } # else { browseURL(env1$path$LastSourceEditorContext.path_file.nb.html %>% {paste0(env1$path$path1,"/",.)}) }
# paste0("https://github.com/mkim0710/",basename(getwd()),"/blob/main/",env1$path$LastSourceEditorContext.path_file.ext) %>% paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',.,'"') |> system(intern=TRUE)
paste0("https://github.com/mkim0710/",basename(getwd()),"/blob/main/",env1$path$LastSourceEditorContext.path_file.ext) %>% paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',.,'"') %>% paste0("'",.,"' |> system(intern=TRUE)") |> cat("  \n", sep="")
# paste0("https://github.com/mkim0710/",basename(getwd()),"/commits/main/",env1$path$LastSourceEditorContext.path_file.ext) %>% paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',.,'"') |> system(intern=TRUE)
paste0("https://github.com/mkim0710/",basename(getwd()),"/commits/main/",env1$path$LastSourceEditorContext.path_file.ext)  %>% paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge_proxy.exe" --app="',.,'"') %>% paste0("'",.,"' |> system(intern=TRUE)") |> cat("  \n", sep="")
cat("* To revert to the last commited file, run the following terminal command:  \n")
paste0( "git checkout -- ",shQuote(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_file.ext)) ) |> deparse() |> cat(" |> system(intern=TRUE)  \n", sep="")
paste0( "git checkout -- ",shQuote(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_file.nb.html)) ) |> deparse() |> cat(" |> system(intern=TRUE)  \n", sep="")
```
