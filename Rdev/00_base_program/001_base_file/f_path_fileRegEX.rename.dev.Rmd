...
env1$path$path1 %>% f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = FALSE, recursive = FALSE, execute = FALSE)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
env1$path$path1 %>% f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = FALSE, execute = FALSE)
...
env1$path$path1 %>% f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = FALSE, execute = FALSE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
env1$path$path1 %>% f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = TRUE, execute = FALSE)
...
# env1$path$path1 %>% f_path_fileRegEX.rename(gsub.pattern_from = gsub.pattern_from, gsub.replacement_to = gsub.replacement_to, full.names = TRUE, recursive = TRUE, execute = TRUE)
