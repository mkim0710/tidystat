...
## @ -------  
# .t0 = Sys.time()
# write_rds( get(.objectname), here::here(.path4write, paste0(.objectname,".rds")), "xz", compression=9L )
# Sys.time() - .t0
...
write_rds( get(.objectname), here::here(.path4write, paste0(.objectname,".rds")) )
Sys.time() - .t0
system(paste0( 'xz --keep -9 --threads=10 "', here::here(.path4write, paste0(.objectname,".rds")), '"' ))
Sys.time() - .t0
