...
# __________|------  
# @@ START) function ----  
## :: f_expression.eval.withCallingHandlers.list_warning.summary = function() -dev  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
...
## :: f_expression.eval.withCallingHandlers.list_warning.summary = function() -dev -success  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
f_expression.eval.withCallingHandlers.list_warning.summary <- function(expression.eval) {
  # Save the current 'warn' option
...
## :: f_expression.eval.withCallingHandlers.attr_warning.summary = function() -dev -success  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
