...
f_CallPrintValues <- function(arg1 = "override1", arg2 = "override2", ..., verbose = TRUE) {
    f_PrintValues(arg1 = arg1, arg2 = arg2, verbose = verbose, ...)
}
...
# Test with overridden arguments
f_CallPrintValues(arg1 = "new_value1", arg3 = "new_value3", verbose = TRUE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")

# Test with additional arguments passed via `...`
f_CallPrintValues(arg1 = "special1", arg3 = "extra3", verbose = TRUE)
...
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
f_CallPrintValues2 <- function(arg1 = "override1", arg2 = "override2", ..., verbose = TRUE) {
    f_PrintValues(...)
}
# Test with default arguments
f_CallPrintValues2()
...
# Test with overridden arguments
f_CallPrintValues2(arg1 = "new_value1", arg3 = "new_value3", verbose = TRUE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")

# Test with additional arguments passed via `...`
f_CallPrintValues2(arg1 = "special1", arg3 = "extra3", verbose = TRUE)
```
...
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
f_CallPrintValues3 <- function(arg1 = "override1", arg2 = "override2", ..., verbose = TRUE) {
    args <- as.list(environment())  # Capture all arguments in the current environment
    do.call(f_PrintValues, args)   # Dynamically pass them to f_PrintValues
}
...
# Test with overridden arguments
f_CallPrintValues3(arg1 = "new_value1", arg3 = "new_value3", verbose = TRUE)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")

# Test with additional arguments passed via `...`
f_CallPrintValues3(arg1 = "special1", arg3 = "extra3", verbose = TRUE)
```
