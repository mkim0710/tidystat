...
set.seed(1); 1:3 %>% map(rnorm, n = 10) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name(rnorm, n = 10, .add.attributes = F) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name2(rnorm, n = 10, .add.attributes = F) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name(rnorm, n = 10, .add.attributes = F, .print.Sys.time = T) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name(rnorm, n = 10, .max.object.size.to.store = 10) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name(rnorm, n = 10) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name2(rnorm, n = 10) |> str(max.level = 2, give.attr = TRUE)

set.seed(1); 1:3 %>% map(~rnorm(10, .x)) |> str(max.level = 2, give.attr = TRUE)
# set.seed(1); 1:3 %>% map.parent_name(~rnorm(10, .x)) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map(function(x) rnorm(10, x)) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name(.f = function(x) rnorm(10, x)) |> str(max.level = 2, give.attr = TRUE)
set.seed(1); 1:3 %>% map.parent_name2(.f = function(x) rnorm(10, x)) |> str(max.level = 2, give.attr = TRUE)
# > set.seed(1); 1:3 %>% map(rnorm, n = 10) |> str(max.level = 2, give.attr = TRUE)
# List of 3
...
mtcars[, 1:3] %>% split(.$cyl) |> str(max.level = 2, give.attr = TRUE)
# > mtcars[, 1:3] %>% split(.$cyl) |> str(max.level = 2, give.attr = TRUE)
# List of 3
...
mtcars %>% split(.$cyl) %>% map(nrow) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name(nrow, .add.attributes = F) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name2(nrow, .add.attributes = F) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name(nrow, .max.object.size.to.store = 10^4) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name2(nrow, .max.object.size.to.store = 10^4) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(~nrow(.x)) |> str(max.level = 2, give.attr = TRUE)
# mtcars %>% split(.$cyl) %>% map.parent_name(~nrow(.x)) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(function(x) nrow(x)) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name(function(x) nrow(x)) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name2(function(x) nrow(x)) |> str(max.level = 2, give.attr = TRUE)
# > mtcars %>% split(.$cyl) %>% map(nrow) |> str(max.level = 2, give.attr = TRUE)
# List of 3
#  $ 4: int 11
#  $ 6: int 7
...
mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name(lm, formula = mpg ~ wt) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name2(lm, formula = mpg ~ wt) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(~ lm(mpg ~ wt, data = .x)) |> str(max.level = 1, give.attr = TRUE)
# mtcars %>% split(.$cyl) %>% map.parent_name(~ lm(mpg ~ wt, data = .x)) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(function(x) lm(mpg ~ wt, data = x)) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name(function(x) lm(mpg ~ wt, data = x)) |> str(max.level = 1, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map.parent_name2(function(x) lm(mpg ~ wt, data = x)) |> str(max.level = 1, give.attr = TRUE)
# > mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) |> str(max.level = 1, give.attr = TRUE)
# List of 3
#  $ 4:List of 12
#   ..- attr(*, "class")= chr "lm"
...
mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) %>% map(length) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) %>% map.parent_name(length, .max.object.size.to.store = 10^4) |> str(max.level = 2, give.attr = TRUE)
mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) %>% map.parent_name2(length, .max.object.size.to.store = 10^4) |> str(max.level = 2, give.attr = TRUE)
# > mtcars %>% split(.$cyl) %>% map(lm, formula = mpg ~ wt) %>% map(length) |> str(max.level = 2, give.attr = TRUE)
# List of 3
#  $ 4: int 12
#  $ 6: int 12
