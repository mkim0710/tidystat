...
"ls(all.names = TRUE, envir = .GlobalEnv) |> set_names() |> map(get) |> str(max.level = 1, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
".tmp |> str(max.level = 1, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
"env1 |> as.list() |> env1$f$f_list.str_by_element(max.level = 2, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
# __________|------  
# @@ START) function ----  
## :: f_expression.withCallingHandlers.list_warning.summary = function() -dev  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
f_expression.withCallingHandlers.list_warning.summary <- function(expression) {
  ...
  result <- tryCatch(
    {
      withCallingHandlers(
        { expression }, # Run the expression provided as an argument
        warning = function(w) {
          # Capture warnings
...
## :: f_expression.withCallingHandlers.list_warning.summary = function() -dev -success  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
f_expression.withCallingHandlers.list_warning.summary <- function(expression) {
  # Save the current 'warn' option
...
if(exists("MetaData")) {
    "MetaData |> str(max.level = 2, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    # "MetaData$tblVarName |> str(max.level = 3, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    # cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    # "MetaData$DataSetNames |> str(max.level = 2, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    # cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    "MetaData$VarNames |> str(max.level = 3, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    "MetaData$VarNames.select |> str(max.level = 3, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    "MetaData$ModelList |> str(max.level = 3, give.attr = FALSE)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
    cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    
    "all.equal(.MetaData0, MetaData)" |> env1$f$f_expression.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4expression = "> ", LinePrefix4Output = "")
