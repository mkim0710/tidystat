...
nBreakdown.list %>% as.matrix %>% as.data.frame %>% rownames_to_column %>% write.table("clipboard", sep="\t", row.names=F, col.names=T)
nBreakdown.list %>% t %>% t %>% as.data.frame %>% rownames_to_column %>% write.table("clipboard", sep="\t", row.names=F, col.names=T)
nBreakdown.list %>% t %>% t %>% as.data.frame %>% rownames_to_column %>% tribble_paste
