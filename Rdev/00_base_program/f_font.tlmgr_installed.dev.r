...
tlmgr_installed_packages.MAGB760M13700KF |> env1$f_vec1_vec2.setdiff(tlmgr_installed_packages.ASRockX300Ryzen5600G) |> str()  ### ----
### > tlmgr_installed_packages.MAGB760M13700KF %>% str  ###----
...
tlmgr_installed_packages.RockerVerse |> env1$f_vec1_vec2.setdiff(tlmgr_installed_packages.ASRockX300Ryzen5600G) |> str()  ### ----
### > tlmgr_installed_packages.RockerVerse |> str()  ###----
