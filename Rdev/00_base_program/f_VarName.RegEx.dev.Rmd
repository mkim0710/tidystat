...
# Step 1: Temporarily mark all digits that are preceded by "apple"
text_temp <- str_replace_all(text, "(?<=apple)(\\d+)", "TOBEIGNORED\\1")
cat("  > ", 'Step 1: Mark digits preceded by "apple"', "\n", text_temp, '"    \n', sep="")

# Step 2: Replace all remaining unmarked digits
text_replaced <- str_replace_all(text_temp, "(?<!TOBEIGNORED)\\d+", "XYZ")
cat("  > ", 'Step 2: Replace all remaining unmarked digits', "\n", text_replaced, '"    \n', sep="")

# Step 3: Remove the temporary marker to restore the original digits
final_result <- str_replace_all(text_replaced, "TOBEIGNORED", "")
cat("  > ", 'Step 3: Remove temporary markers', "\n", final_result, '"    \n', sep="")
