...
cat('### Example 1: Positive Lookahead', "\n", sep="")
text <- "apple123banana"

# Using gsub with perl=TRUE
cat("\n > ", 'gsub("\\d+(?=banana)", "XYZ", text, perl=TRUE)', "\n", gsub("\\d+(?=banana)", "XYZ", text, perl=TRUE), "\n", sep="")

# Using stringr::str_replace_all
cat("\n > ", 'str_replace_all(text, "\\\\d+(?=banana)", "XYZ")', "\n", str_replace_all(text, "\\d+(?=banana)", "XYZ"), "\n", sep="")

cat("\n\n")

cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
### Example 2: Negative Lookahead
cat('### Example 2: Negative Lookahead', "\n", sep="")
text <- "apple123banana"
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
### Example 3: Positive Lookbehind (?<=LookbehindAnchor)
cat('### Example 3: Positive Lookbehind (?<=)', "\n", sep="")
text <- "apple123banana"

# Using gsub with perl=TRUE
cat("\n > ", 'gsub("(?<=apple)\\d+", "XYZ", text, perl=TRUE)', "\n", gsub("(?<=apple)\\d+", "XYZ", text, perl=TRUE), "\n", sep="")

# Attempt for positive lookbehind using stringr::str_replace_all 
cat("\n > ", 'str_replace_all(text, "apple(\\\\d+)", "appleXYZ")', "\n", str_replace_all(text, "apple(\\d+)", "appleXYZ"), "\n", sep="")
...
cat('### Example 4: Negative Lookbehind', "\n", sep="")
text <- "apple123banana"
...
# Using stringr::str_replace_all (not supported, so using a workaround)
cat("\n > ", 'str_replace_all(text, "(?<!apple)(\\\\d+)", "XYZ")', "\n", "Workaround needed: ICU does not support lookbehind, so you'll need to handle this differently.", "\n", sep="")
...
cat("\n > ", 'Step 1: Mark digits preceded by "apple"', "\n", text_temp, "\n", sep="")
...
cat("\n > ", 'Step 3: Remove temporary markers', "\n", final_result, "\n", sep="")
