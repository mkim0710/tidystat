...
recover_untitled_files <- function(project_dir = ".", print.intermediate = FALSE) {
  # Define the path to the sources directory
  sources_dir <- file.path(project_dir, ".Rproj.user", "E3EEE3A9", "sources")
  ...
  # Print the paths of recovered files if print.intermediate is TRUE
  if (print.intermediate) {
...
# Example usage:
# recovered_files <- recover_untitled_files(print.intermediate = TRUE)
recovered_files <- recover_untitled_files()
recovered_files |> str()
# > recovered_files |> str()
# List of 25
#  $ : chr "recovered_untitled_files/Untitled-Untitled1-06A2BF28.R"
#  $ : NULL
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_untitled_files/Untitled-Untitled1-22452B12.R"
#  $ : NULL
#  $ : NULL
#  $ : NULL
#  $ : NULL
...
#  $ : NULL
#  $ : NULL
#  $ : chr "recovered_untitled_files/Untitled-Untitled1-A05040E0.R"
#  $ : NULL
#  $ : chr "recovered_untitled_files/Untitled-Untitled1-D14D3FDE.R"
#  $ : NULL
#  $ : chr "recovered_untitled_files/Untitled-Untitled1-E01BF946.R"
#  $ : NULL
#  $ : NULL
#  $ : NULL
#  $ : NULL
