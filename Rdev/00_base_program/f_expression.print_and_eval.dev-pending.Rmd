...
# \$ e1 = as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
e1 = as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])
ls(envir = e1)
...
## *** \% |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]]))  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
# https://chatgpt.com/c/2c33cac5-5297-4385-90de-4277a03196f1
#|%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%|#  
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
dim(get(DataSetName)) |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) 
dim(get(DataSetName)) |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> str()
dim(get(DataSetName)) |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> deparse() %>% cat(" > ",.," |> dput()  \n", sep="")
dim(get(DataSetName)) |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> eval() |> dput() 
```
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
dim(get(DataSetName)) |> expression() |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) 
dim(get(DataSetName)) |> expression() |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> str()
dim(get(DataSetName)) |> expression() |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> deparse() %>% cat(" > ",.," |> dput()  \n", sep="")
dim(get(DataSetName)) |> expression() |> substitute(as.environment(as.list(.GlobalEnv)[ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]])) |> eval() |> dput() 
```  
...
f_expression.print_and_eval <- function(text_expression = "", vec_chr_names) {
    vec_chr_names = ls(envir=.GlobalEnv)[ls(envir=.GlobalEnv) |> map_lgl(function(objectname) is.character(get(objectname, envir=.GlobalEnv)))]
    vec_chr_names |> print()
    vec_chr_names |> substitute() |> print() 
    vec_chr_names[1] |> substitute() |> print() 
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    assign(vec_chr_names[1], get(vec_chr_names[1], envir = .GlobalEnv))
    vec_chr_names[1] |> substitute() |> print() 
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    text_expression |> print()
    text_expression |> substitute() |> print() 
    print(substitute(text_expression))
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    text_expression |> as.expression() |> print()
    text_expression |> as.expression() |> substitute() |> print() 
}
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
f_expression.print_and_eval()
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
f_expression.print_and_eval(.text_expression)
...
f_expression.print_and_eval <- function(text_expression = "", vec_chr_names) {
    str(text_expression)
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    str(as.expression(text_expression))
    str(quote(as.expression(text_expression)))
    str(substitute(as.expression(text_expression)))
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    str(eval(as.expression(text_expression)))
    str(eval(quote(as.expression(text_expression))))
    str(eval(substitute(as.expression(text_expression))))
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    str(eval(eval(as.expression(text_expression))))
    str(eval(eval(quote(as.expression(text_expression)))))
    str(eval(eval(substitute(as.expression(text_expression)))))
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
    expr = as.expression(text_expression)
    str(expr)
    str(quote(expr))
    str(substitute(expr))
}
