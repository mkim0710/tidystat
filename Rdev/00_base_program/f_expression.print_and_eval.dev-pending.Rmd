...
#@@ START) function ----  
## \% |> f_expression.echo_and_print 
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)

.text_expression = "dim(get(DataSetName))"
f_expression.echo_and_print <- function(text_expression = "", vec_chr_names) {
    str(text_expression)
    cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
...
f_expression.echo_and_print(text_expression = .text_expression)
```
