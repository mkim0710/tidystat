...
# #     ' if (Sys.info()["sysname"] == "Windows") { env1$env.internal$f_file_PDF.sumatra("',env1$path$LastSourceEditorContext.path_filename.pdf %>% {paste0(env1$path$path1,"/",.)},'") } else { browseURL("',env1$path$LastSourceEditorContext.path_filename.pdf %>% {paste0(env1$path$path1,"/",.)},'") }',"\n",
# #     ' env1$env.internal$f_filename.ext.createBackup(backup_from_path_filename.ext = "',env1$path$LastSourceEditorContext.path_filename.pdf %>% {paste0(env1$path$path1,"/",.)},'", .backup_to_path="-backup", timeFormat="%y%m%d", overwrite=TRUE)',"  \n", sep="")
# # cat("    ________________________________________________________________________    \n")
...
#     ' env1$env.internal$f_filename.ext.createBackup(backup_from_path_filename.ext = "',env1$path$LastSourceEditorContext.path_filename.html %>% {paste0(env1$path$path1,"/",.)},'", .backup_to_path="-backup", timeFormat="%y%m%d", overwrite=TRUE)',"  \n", sep="")
```
