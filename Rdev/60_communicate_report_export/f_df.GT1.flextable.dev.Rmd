...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
# :: DS.DNR = DataSet.Date.NA.rmAllNA = ===== 
if(!exists("DSN")) {  warning('!exists("DSN") --> setting DSN = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"'); DSN = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"; df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct = read_csv(file.path("../Rproject_KoGES_AA10030/df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct.UTF8.csv"))  }  
DS.DNR = get(DSN) %>% 
