...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
# :: DS.DNR = DataSet.Date.NA.rmAllNA = ===== 
if(!exists("DSN")) {warning('!exists("DSN") --> setting DSN = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"'); DSN = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"}
cat("DSN == ", deparse(DSN), "\n", sep = "")
