...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
# :: DS.DNR = DataSet.Date.NA.rmAllNA = ===== 
if(!exists("DSN")) {  warning('!exists("DSN"); '); DSN = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"; cat("DSN == ", deparse(DSN), "\n", sep = ""); assign(DSN, read_csv(paste0("../Rproject_KoGES_AA10030/",DSN,".UTF8.csv")))  }  
DS.DNR = get(DSN) %>% 
