...
# if (!requireNamespace("Z.gtsummary.addons", quietly = TRUE)) remotes::install_github("zheer-kejlberg/Z.gtsummary_addons")
if (!requireNamespace("Z.gtsummary.addons", quietly = TRUE)) remotes::install_github("ddsjoberg/Z.gtsummary_addons")
library(Z.gtsummary.addons)
```
