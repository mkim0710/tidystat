...
# DataSetName = "df_NewDMv3.CensorEND.n88.select293.NR.recode"
DataSetName = "df_NewDMv3.CensorEND.n88.select293.NR.recode.lbl.fct"
...
assign(  DataSetName, read_csv(file.path(.path4read, paste0(DataSetName,".UTF8.csv")))  )   
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
# DataSet.DNR |> env1$f$f_df.Table1byExposure.xlsx(DataSetName4output = .DataSetName4output, VarNames4Exposure = .VarNames4Exposure, output.xlsx = Sys.getenv("PARENT_RENDERING") != "YES") |> env1$f$f_expression.eval.withCallingHandlers.attr_warnings.summary()
```
...
GT1 = DataSet %>% 
    ...
    # modify_table_styling(columns = "label", fmt_fun = function(i.label) {paste0(names(DataSet), " (", i.label, ")")}) |>
    ...
    modify_spanning_header(all_stat_cols() ~ paste0("**",ifelse(is.null(labelled::var_label(DataSet[[.byVar]])), .byVar, labelled::var_label(DataSet[[.byVar]])),"**")) |>
    bold_p(t = 0.10) |>
    bold_labels() |>
    italicize_levels()
