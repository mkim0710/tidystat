...
gtTable1 = trial %>% 
    ...
    bold_labels() |>
    italicize_levels()
gtTable1 %>% show_header_names
gtTable1$table_body %>% select(starts_with("variable"), label, starts_with("stat"), starts_with("SMD"), starts_with("test_result") , starts_with("statistic"), starts_with("parameter") , p.value) |> print(n=99)
gtTable1 |>
    print() |> invisible()
```
...
.wb$save("gtTable1.flextable.xlsx")
```
