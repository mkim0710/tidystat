...
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
.VarNames4Exposure =  c("A01_BMI.5category")  
...
gtsummary_Table1 = trial %>% 
    ...
    bold_labels() |>
    italicize_levels()
gtsummary_Table1 %>% show_header_names
gtsummary_Table1$table_body %>% select(variable, label, starts_with("stat"), starts_with("SMD"), test_result , statistic, parameter , p.value) |> print(n=99)
gtsummary_Table1 |>
    print() |> invisible()
```
...
.wb$save("gtsummary_Table1.flextable.xlsx")
```
