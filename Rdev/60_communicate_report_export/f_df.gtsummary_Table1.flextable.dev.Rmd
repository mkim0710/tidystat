...
tbl = DataSet.Date.NA.rmAllNA %>% 
    ...
    modify_spanning_header(all_stat_cols() ~ paste0("**",ifelse(is.null(labelled::var_label(DataSet.Date.NA.rmAllNA[[.byVar]])), .byVar, labelled::var_label(DataSet.Date.NA.rmAllNA[[.byVar]])),"**")) |>
    bold_p(t = 0.10) |>
    bold_labels() |>
    italicize_levels()
tbl %>% show_header_names
