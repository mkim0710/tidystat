...
gtTable2_uvregression = trial %>% 
    ...
    bold_labels() |>
    italicize_levels()
gtTable2_uvregression %>% show_header_names
gtTable2_uvregression$table_body %>% select(variable, N_obs, N_event, label, estimate, std.error, statistic, conf.low, conf.high, ci, p.value) |> print(n=99)
gtTable2_uvregression |>
    print() |> invisible()
```
...
.objectname = "gtTable2_uvregression"
