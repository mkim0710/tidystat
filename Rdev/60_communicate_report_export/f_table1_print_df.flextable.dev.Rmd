...
table1_df <- f_DataSet.table1.print.df(
    GermanBreastCancerStudyGroup, 
...
### :: flextable1 = table1_df |> f_table1_print_df.flextable() ----
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
...
flextable1 <- f_table1_print_df.flextable(table1_df, header_text = header_text, footer_text = footer_text)
flextable1
```
