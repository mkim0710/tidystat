...
#     
#     # add the flextable ft to the workbook, sheet "flextable"
#     # offset the table to cell 'C2'
#     .wb <- wb_add_flextable(.wb, "flextable", .ft, dims = "C2")
#     
#     .wb %>% str(max.level = 2)
#     
...
#     .wb$save(.tmpfile)
#     if(Sys.info()["sysname"] == "Windows") openxlsx2::xl_open(.tmpfile)
# }

if (Sys.getenv("PARENT_RENDERING") != "YES") {
    .wb <- openxlsx2::wb_workbook()
    
    for (.objectname in c("GermanBreastCancerStudyGroup", "table1_print_df")) {    # name of the data.frame object  
    ...
    for (.objectname in c("flextable1")) {    # name of the flextable object  
        .wb$add_worksheet(.objectname)  # make sheet name same as .objectname
        .wb <- .wb %>% wb_add_flextable(.objectname, get(.objectname), start_col = 2, start_row = 3)    # offset the table to cell 'C2'
    }
