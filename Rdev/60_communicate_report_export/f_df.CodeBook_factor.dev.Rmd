...
# env1$path$print_tree_path_files.DataSet = env1$path$df_dirs_recursive.df_files |> dplyr::filter(path.level <= 5) |> 
#     dplyr::select(print_tree_path_files.DataSet) |> unlist() |> paste(collapse="") 
# env1$path$print_tree_path_files.DataSet |> cat("  \n", sep="")
```
...
converted_data <- f_DataSet_CodeBook.map_factor(your_data, MetaData, print.intermediate = TRUE)
