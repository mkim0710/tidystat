...
create_labelled_data <- function(var, value_options, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = getOption("verbose")) {
...
apply_codebook_labeling <- function(data, codebook, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = getOption("verbose")) {
