...
f_vec_ValueOptions.factor <- function(vec, ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = isTRUE(getOption("verbose"))) {
...
# Apply the function
sex_factor <- f_vec_ValueOptions.factor(sex_vector, sex_ValueOptions, VERBOSE = TRUE)
...
f_DS_CodeBook.map_factor <- function(DS, df_VarName_ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = isTRUE(getOption("verbose"))) {
...
converted_data <- f_DS_CodeBook.map_factor(your_data, MetaData$tblVarName$tblVarName.suffix, VERBOSE = TRUE)
...
f_DS_CodeBook.map_factor <- function(DS, df_VarName_ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = isTRUE(getOption("verbose"))) {
  ...
  DS <- map2(df_VarName_ValueOptions$VarName.suffix, df_VarName_ValueOptions$ValueOptions, 
...
converted_DS <- f_DS_CodeBook.map_factor(DS, df_VarName_ValueOptions, VERBOSE = TRUE)
...
f_DS_CodeBook.walk2factor <- function(DS, df_VarName_ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = isTRUE(getOption("verbose"))) {
...
converted_DS <- f_DS_CodeBook.walk2factor(DS, df_VarName_ValueOptions, VERBOSE = TRUE)
...
.GlobalEnv$env1$source[[.filename.source.r]]
