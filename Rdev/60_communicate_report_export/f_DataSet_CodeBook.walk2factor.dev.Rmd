...
f_vec_ValueOptions.factor <- function(vec, ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = getOption("verbose")) {
...
f_DataSet_CodeBook.map_factor <- function(DataSet, df_VarName_ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = getOption("verbose")) {
...
converted_data <- f_DataSet_CodeBook.map_factor(your_data, MetaData$tblVarName$tblVarName.suffix, VERBOSE = TRUE)
...
converted_DataSet <- f_DataSet_CodeBook.map_factor(DataSet, df_VarName_ValueOptions, VERBOSE = TRUE)
...
f_DataSet_CodeBook.walk2factor <- function(DataSet, df_VarName_ValueOptions, sep4levels = ",\\s*", sep4name_value = "=", VERBOSE = getOption("verbose")) {
...
converted_DataSet <- f_DataSet_CodeBook.walk2factor(DataSet, df_VarName_ValueOptions, VERBOSE = TRUE)
