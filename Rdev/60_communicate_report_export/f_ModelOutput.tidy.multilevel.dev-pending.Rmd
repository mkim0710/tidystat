...
for (.objectname in names(MetaData$DataSetNames)) {
    if (exists(.objectname)) {
        .path.file = paste0(.path4write,"/",.objectname,".rds",".xz"); cat("> .path.file = ", .path.file, "  \n", sep="")
        ...
        env1$f$f_file.git_lfs_track_add_f(.path.file, execute_code = FALSE)
    } else {
        cat("> !exists(", deparse(.objectname), ")  \n", sep="")
    }
}
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
