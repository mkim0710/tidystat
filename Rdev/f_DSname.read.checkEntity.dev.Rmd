...
```{r}
# "f_DSname.Search.read.checkEntity.source.r" %>% env1$env.internal.attach$f_file.edit_if_exists()
...
## \% f_DSname.Search.read.checkEntity(print2console = FALSE) =======  
```{r RUN-ALL-CHUNKS-ABOVE, echo=FALSE, results="hide", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
#| RUN ALL CHUNKS ABOVE: CTRL+ALT+SHIFT+P |#
...
# Warning messages:
# 1: In env1$f$f_DSname.Search.read.checkEntity(DSN = .objectname) :
#   getwd() != .path4read == "."
# 2: In env1$f$f_DSname.Search.read.checkEntity(DSN = .objectname) :
#   varname for ID not identified among: c("ID", "CompositeKey", "PERSON_ID", "RN_INDI", "NIHID")
```
  
  
  
## \% f_DSname.Search.read.checkEntity(vec_candidate4ID = "randid", print2console = FALSE) =======  
...
## \% f_DSname.Search.read.checkEntity(print2console = TRUE, return.output = FALSE) =======  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
env1$f$f_DSname.Search.read.checkEntity(DSN = DSN, vec_candidate4ID = "randid", print2console = TRUE, return.output = FALSE)
```
  
  
## \% f_DSname.Search.read.checkEntity(print2console = TRUE, return.output = TRUE) =======  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
options(width=120)
env1$f$f_DSname.Search.read.checkEntity(DSN = DSN, print2console = TRUE, return.output = TRUE)
```
