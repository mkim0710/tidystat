...
# txt = "N1GM0390 N1GM0392 N1GM0392_recode N1GM0394 N1GM0394_recode Cigar"
# 
# txt |> str_extract_all("[A-Za-z_]+")
# txt |> str_extract_all("[A-Za-z0-9_]+")
# # > txt |> str_extract_all("[A-Za-z_]+")
# # [[1]]
...
# 
# 
# txt |> str_extract_all("[A-Za-z0-9_]+") |> unlist() |> paste0(collapse = '\\", \\"') %>% {paste0('"', ., '"')}
# txt |> str_extract_all("[A-Za-z0-9_]+") |> unlist() |> paste0(collapse = '\\", \\"') %>% {paste0('"', ., '"')} |> cat("  \n", sep="")
# txt |> str_extract_all("[A-Za-z0-9_]+") |> paste0(collapse = '", "') %>% {paste0('"', ., '"')}
# txt |> str_extract_all("[A-Za-z0-9_]+") |> paste0(collapse = '", "') %>% {paste0('"', ., '"')} |> cat("  \n", sep="")
# # > txt |> str_extract_all("[A-Za-z0-9_]+") |> unlist() |> paste0(collapse = '\\", \\"') %>% {paste0('"', ., '"')}
# # [1] "\"N1GM0390\\\", \\\"N1GM0392\\\", \\\"N1GM0392_recode\\\", \\\"N1GM0394\\\", \\\"N1GM0394_recode\\\", \\\"Cigar\""
# # > txt |> str_extract_all("[A-Za-z0-9_]+") |> unlist() |> paste0(collapse = '\\", \\"') %>% {paste0('"', ., '"')} |> cat("  \n", sep="")
# # "N1GM0390\", \"N1GM0392\", \"N1GM0392_recode\", \"N1GM0394\", \"N1GM0394_recode\", \"Cigar"> txt |> str_extract_all("[A-Za-z0-9_]+") |> paste0(collapse = '", "') %>% {paste0('"', ., '"')}
...
txt |> str_split(boundary("word")) |> unlist() |> paste0(collapse = '", "') %>% {paste0('c("',.,'")')}|> cat("  \n", sep="")
txt |> str_extract_all("[A-Za-z0-9_]+") |> paste0(collapse = ', ') |> cat("  \n", sep="")
txt |> str_extract_all("[A-Za-z0-9_]+") |> unlist() |> paste0(collapse = '", "') %>% {paste0('c("', ., '")')} |> cat("  \n", sep="")
# > txt %>% gsub(" ", '\\", \\"', .) %>% {paste0('"', ., '"')} %>% {paste0('c(', ., ')')} |> cat("  \n", sep="")
# c("N1GM0390", "N1GM0392", "N1GM0392_recode", "N1GM0394", "N1GM0394_recode", "Cigar")
# > txt |> str_split(boundary("word")) |> unlist() |> paste0(collapse = '", "') %>% {paste0('c("',.,'")')}|> cat("  \n", sep="")
# c("N1GM0390", "N1GM0392", "N1GM0392_recode", "N1GM0394", "N1GM0394_recode", "Cigar")
