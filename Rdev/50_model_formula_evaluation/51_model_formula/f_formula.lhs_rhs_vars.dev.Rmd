...
.listname = "MetaData"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "DataSetNames"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "VarNames"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "VarNames.select"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "VarNames.filter"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "VarNames.recode"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
.listname = "ModelList"; if(!.listname %in% names(.GlobalEnv$CODEBOOK)) { .GlobalEnv$CODEBOOK[[.listname]] <- list() }
```
...
#### \$ CODEBOOK$ModelList$time2event$formula ====  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)

library(survival)
CODEBOOK$ModelList$time2event$formula = Surv(time = time2event, event = event) ~ Group + StudyPopulation + A00_SEX + A01_AGE
CODEBOOK$ModelList$time2event$formula %>% print
CODEBOOK$ModelList$time2event$formula %>% str
CODEBOOK$ModelList$time2event$formula %>% dput
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
CODEBOOK$ModelList$time2event$formula[[1]]
CODEBOOK$ModelList$time2event$formula[[1]] %>% str
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
CODEBOOK$ModelList$time2event$formula[[2]]
CODEBOOK$ModelList$time2event$formula[[2]] %>% str
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
CODEBOOK$ModelList$time2event$formula[[3]]
CODEBOOK$ModelList$time2event$formula[[3]] %>% str
```
  
  
#### \$ CODEBOOK$ModelList$time2event$terms ====  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
CODEBOOK$ModelList$time2event$terms = CODEBOOK$ModelList$time2event$formula |> terms()
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$terms %>% print
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$terms %>% str
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$terms %>% dput
```
  
  
#### \$ CODEBOOK$ModelList$time2event$all.vars ====  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
CODEBOOK$ModelList$time2event$all.vars = CODEBOOK$ModelList$time2event$formula |> all.vars()
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$all.vars %>% print
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$all.vars %>% str
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$all.vars %>% dput
```
  
  
#### \$ CODEBOOK$ModelList$time2event$lhs.vars ====  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
CODEBOOK$ModelList$time2event$lhs = CODEBOOK$ModelList$time2event$formula[[2]]
CODEBOOK$ModelList$time2event$lhs.vars = CODEBOOK$ModelList$time2event$lhs %>% all.vars
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$lhs.vars %>% print
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$lhs.vars %>% str
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$lhs.vars %>% dput
```
  
  
#### \$ CODEBOOK$ModelList$time2event$rhs.vars ====  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
CODEBOOK$ModelList$time2event$rhs = CODEBOOK$ModelList$time2event$formula[[3]]
CODEBOOK$ModelList$time2event$rhs.vars = CODEBOOK$ModelList$time2event$rhs %>% all.vars
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$rhs.vars %>% print
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$rhs.vars %>% str
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
CODEBOOK$ModelList$time2event$rhs.vars %>% dput
```
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
CODEBOOK$ModelList$time2event$formula = NULL
CODEBOOK$ModelList$time2event %>% str(max.level = 1, give.attr = F)
CODEBOOK$ModelList$time2event$formula
```
...
CODEBOOK$ModelList$time2event = NULL
CODEBOOK$ModelList$time2event$formula = Surv(time = time2event, event = event) ~ Group + StudyPopulation + A00_SEX + A01_AGE
CODEBOOK$ModelList$time2event$formula.lhs_rhs_vars = 
    CODEBOOK$ModelList$time2event$formula %>% f_formula.lhs_rhs_vars()
...
## \% |> f_list_formula.append_lhs_rhs_vars(CODEBOOK$ModelList$time2event)
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
.subsublistname = "time2event"; .sublistname = "ModelList"; .parentname = "CODEBOOK"; if(!.subsublistname %in% names(.GlobalEnv[[.parentname]][[.sublistname]])) { .GlobalEnv[[.parentname]][[.sublistname]] = list() }
...
library(survival)
CODEBOOK$ModelList$time2event = NULL
CODEBOOK$ModelList$time2event = CODEBOOK$ModelList$time2event %>% f_list_formula.append_lhs_rhs_vars()
CODEBOOK$ModelList$time2event %>% str(max.level = 2, give.attr = F)
