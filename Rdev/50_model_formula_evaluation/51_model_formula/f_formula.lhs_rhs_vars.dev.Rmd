...
#@@ START) function: env1$f$f_formula.lhs_rhs_vars  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
...
## \% |> c(CODEBOOK$ModelList$time2event$formula |> env1$f$env1$f$f_formula.lhs_rhs_vars(formula_in_the_list = FALSE))
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
.subsublistname = "time2event"; .sublistname = "ModelList"; .parentname = "CODEBOOK"; if(!.subsublistname %in% names(.GlobalEnv[[.parentname]][[.sublistname]])) { .GlobalEnv[[.parentname]][[.sublistname]] = list() }
...
CODEBOOK$ModelList$time2event = CODEBOOK$ModelList$time2event |> c(CODEBOOK$ModelList$time2event$formula |> env1$f$env1$f$f_formula.lhs_rhs_vars(formula_in_the_list = FALSE))
...
CODEBOOK$ModelList$time2event$formula.lhs_rhs_vars = 
    CODEBOOK$ModelList$time2event$formula %>% env1$f$f_formula.lhs_rhs_vars()
...
#@@ START) function: env1$f$f_list_formula.append_lhs_rhs_vars  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
