...
# if (.Platform$OS.type == "windows") openxlsx2::xl_open("svyglm 10var vs 10var.inter.xlsx")
...
# if (.Platform$OS.type == "windows") openxlsx2::xl_open("svyglm US_BORN_T.10var vs US_BORN_F.10var.xlsx")
...
if (.Platform$OS.type == "windows") openxlsx2::xl_open("svyglm.MainModel.byEffectModifier.xlsx")
