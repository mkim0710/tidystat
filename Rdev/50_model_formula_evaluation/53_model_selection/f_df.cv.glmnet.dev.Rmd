...
#### :: TheTrainSet.cv.glmnet.a10
##### :: TheTrainSet.cv.glmnet.a10.coef = TheTrainSet.cv.glmnet.a10 |> 
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}

alpha = 1
# Train glmnet Cox models
TheTrainSet.cv.glmnet.a10 <- f_df.cv.glmnet(
...
# .objectname = "TheTrainSet.cv.glmnet.a10"
...
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.mat_coef()
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.mat_coef() %>% str()
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.mat_coef() %>% as.matrix() %>% as.data.frame() %>% str()
```
...
## :: f_cv_glmnet_object.vec_VarName_lamda = function()
### :: f_cv_glmnet_object.list_VarName_lamda = function()
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
f_cv_glmnet_object.vec_VarName_lamda <- function(cv_glmnet_object, lambda = "lambda.min") {
...
f_cv_glmnet_object.list_VarName_lamda = function(cv_glmnet_object, vec_lambda = c("lambda.min", "lambda.1se")) {
    list_VarName_lamda = vec_lambda %>% set_names() %>% map(~ cv_glmnet_object %>% f_cv_glmnet_object.vec_VarName_lamda(lambda = .x))
...
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.vec_VarName_lamda(lambda = "lambda.min") %>% dput
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.vec_VarName_lamda(lambda = "lambda.1se") %>% dput

cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet.a10 %>% f_cv_glmnet_object.list_VarName_lamda() %>% str()
...
runph_on_test <- function(cv_glmnet_object, train_formula, test_data, lambda = "lambda.min") {
  vec_VarName_lamda <- f_cv_glmnet_object.vec_VarName_lamda(cv_glmnet_object, lambda = lambda)
...
coxph_summaries <- generate_summaries(
  glmnet_models = TheTrainSet.cv.glmnet.a10,
