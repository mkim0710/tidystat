...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
TheTrainSet.cv.glmnet_cox.a00 %>% str(max.level = 1)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet_cox.a00$glmnet.fit %>% str(max.level = 1)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
...
TheTrainSet.cv.glmnet_cox.a00.list_coef %>% str
...
TheTrainSet.cv.glmnet_cox.a00.mat_coef %>% str()
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
TheTrainSet.cv.glmnet_cox.alphas %>% str(max.level = 1)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet_cox.alphas[[1]] %>% str(max.level = 1)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet_cox.alphas[[1]]$glmnet.fit %>% str(max.level = 1)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
...
# TheTrainSet.cv.glmnet_cox.alphas.coef_list_list %>% str
# 
# cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
...
# })()
# 
# TheTrainSet.cv.glmnet_cox.alphas.coef %>% str()
