...
# 
# load(url("https://raw.githubusercontent.com/mkim0710/tidystat/master/data/library_glmnet_coxExample_tibble.rda"))
...
# # save(list = .objectname, file = .path_file)
# # paste0( "git add -f ",shQuote(.path_file) ) %>% system()
# load(url("https://raw.githubusercontent.com/mkim0710/tidystat/master/data/library_glmnet_gaussianExample_tibble.rda"))
# 
...
# save(list = .objectname, file = .path_file)
# paste0( "git add -f ",shQuote(.path_file) ) %>% system()
load(url("https://raw.githubusercontent.com/mkim0710/tidystat/master/data/library_glmnet_binomialExample_tibble.rda"))
