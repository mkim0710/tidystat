...
# glmnet.fit |> plot(label = TRUE, type.coef = "2norm")
glmnet.fit |> plot(label = TRUE, xvar = "lambda")
glmnet.fit |> plot(label = TRUE, xvar = "dev")
glmnet.fit |> plot(label = TRUE, xvar = "norm")
```
...
coefs <- as.matrix(coef(glmnet.fit))
coefs[1:9, 1:9]
coefs %>% str
coefs[-1, ] %>% str
