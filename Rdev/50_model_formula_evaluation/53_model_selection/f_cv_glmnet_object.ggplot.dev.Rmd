...
# Fit glmnet model
glmnet_object = glmnet(x, y)
glmnet_object_enet = glmnet(x, y, alpha = 0.5)  # Elastic net
```
...
glmnet_object_enet |> plot(label = TRUE, xvar = "norm")
```
...
glmnet_object_enet <- cv.glmnet(x, y, alpha = 0.5)

# Plot with Elastic Net penalty as x-axis
f_cv_glmnet_object_enet.ggplot(glmnet_object_enet, xvar = "lambda", label = TRUE)
f_cv_glmnet_object_enet.ggplot(glmnet_object_enet, xvar = "dev", label = TRUE)
f_cv_glmnet_object_enet.ggplot(glmnet_object_enet, xvar = "norm", label = TRUE)
f_cv_glmnet_object_enet.ggplot(glmnet_object_enet, xvar = "penalty", label = TRUE)
