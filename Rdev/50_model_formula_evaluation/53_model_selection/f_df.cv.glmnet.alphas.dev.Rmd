...
# TheTrainSet = CoxExample_tibble %>% select(-time)
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
TheTrainSet.cv.glmnet.alphas %>% str(max.level = 1)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet.alphas[[1]] %>% str(max.level = 1)
cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
TheTrainSet.cv.glmnet.alphas[[1]]$glmnet.fit %>% str(max.level = 1)
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
...
# TheTrainSet.cv.glmnet.alphas.coef_list_list %>% str
# 
# cat("    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n")
...
# })()
# 
# TheTrainSet.cv.glmnet.alphas.coef %>% str()
