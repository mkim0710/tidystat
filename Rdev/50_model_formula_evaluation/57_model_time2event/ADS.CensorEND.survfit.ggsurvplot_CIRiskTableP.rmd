...
FileName2read = if(file.exists(here::here(.path4read, paste0(.objectname,".rds")))) paste0(.objectname,".rds") else paste0(.objectname, ".rds.xz")
env1$f$f_path.size_files(.path4read = .path4read, regex4FileName = FileName2read)
system.time(assign(.objectname, readRDS(here::here(.path4read, FileName2read)), envir=.GlobalEnv))
...
## \$ df_NewDMv3.NAtime200621 \%>\% { write_rds(here::here(.path4write, paste0(deparse(substitute(.)),".rds"))) } ----  
