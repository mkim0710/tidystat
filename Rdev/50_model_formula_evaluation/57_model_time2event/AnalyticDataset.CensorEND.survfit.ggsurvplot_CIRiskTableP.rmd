...
# _______________
```{markdown Rstudio-RMarkDown-Shortcuts, include=FALSE}
...
```{r envCustomInfo, paged.print=FALSE, collapse=TRUE, echo=FALSE, message=FALSE, results=FALSE}
...
```{r, paged.print=FALSE, collapse=TRUE, echo=FALSE}
...
```{r, paged.print=FALSE, fig.width=8, fig.height=6, include=FALSE}
library(tidyverse)
# library(survival)
# library(survminer)
...
# @@ END -----
```{r END, paged.print=FALSE, collapse=TRUE, include=FALSE}
# @@ END -----
```
