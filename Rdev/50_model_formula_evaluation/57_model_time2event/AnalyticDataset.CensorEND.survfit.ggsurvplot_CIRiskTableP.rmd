...
#|________________________________________________________________________________|#  
#@ Old code replaced) load(url("https://raw.githubusercontent.com/mkim0710/tidystat/master/f_df.t.tribble_construct.RData")) ----  
## env1\$path ----  
...
regex4filename = "\\.rds\\.xz$"
list.files(.path4write) %>% grep(regex4filename, ., value = T) |> deparse(width.cutoff=120-15) |> paste0(collapse="  \n  ") %>% {cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n", ., "  \n", sep="")}  # dput(); |> deparse(width.cutoff=120-15) |> paste0(collapse="  \n  ") |> cat("  \n", sep=""); # width.cutoff=500 is the max ----    
