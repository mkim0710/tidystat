...
knitr::opts_chunk$set(
  eval=TRUE, echo=TRUE, results='hold', collapse=TRUE, # In Rstudio Notebook Source Pane & nb.HTML, results='hold' does not work
...
sourcename = "f_df.t.tribble_construct"; suppressPackageStartupMessages(source(file.path(file.path(env.custom$path$source_base_local,""), paste0(sourcename,".source.r")) ))
...
sourcename = "get_system_info"; suppressPackageStartupMessages(source(file.path(file.path(env.custom$path$source_base_local,""), paste0(sourcename,".source.r")) ))
...
```{r envCustom-Path-NoEcho, echo=FALSE, results='hold', collapse=TRUE, paged.print=FALSE}
...
path4read = getwd()
path4write = getwd()
sourcename = "f_objectname.read.checkEntity"; suppressPackageStartupMessages(source(file.path(file.path(env.custom$path$source_base_local,""), paste0(sourcename,".source.r")) ))
...
```{r objectname-read.checkEntity, echo=TRUE, results='hold', collapse=TRUE, paged.print=FALSE, comment='', R.options=list(width=120)}
options(width=120)
sourcename = "f_objectname.read.checkEntity"; suppressPackageStartupMessages(source(file.path(file.path(env.custom$path$source_base_local,""), paste0(sourcename,".source.r")) ))
