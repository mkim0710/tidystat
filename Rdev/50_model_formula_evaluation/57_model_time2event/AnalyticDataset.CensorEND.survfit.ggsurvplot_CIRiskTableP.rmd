...
```{r width80, echo=TRUE, warning=TRUE, error=TRUE, message=TRUE, results='hold', collapse=TRUE, paged.print=FALSE}
options(width = 80)
```{r, paged.print=FALSE, collapse=TRUE}
if (getwd() != path4read) warning("getwd() != path4read == ") else cat("getwd() == path4read == "); dput(path4read)  #----
...
```{r, results='hold', collapse=TRUE, paged.print=FALSE, comment = '', R.options=list(width=80)}
options(width = 80)
