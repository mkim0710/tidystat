...
df_NewDMv3.CensorEND = df_NewDMv3.NAtime |> 
    ...
    as_tibble()
survminer::ggsurvplot(survival::survfit(survival::Surv(time = time, event = event) ~ Group, data = df_NewDMv3.CensorEND |> dplyr::filter(StudyPopulation)), palette = c("#00AFBB", "#FC4E07")
...
# #  3rd Qu.:365.0                                               
# #  Max.   :365.0                                               
# survminer::ggsurvplot(survival::survfit(survival::Surv(time = time, event = event) ~ Group, data = df_time2event.CensorEND |> dplyr::filter(StudyPopulation)), palette = c("#00AFBB", "#FC4E07")
#            , break.time.by = value_for_break.time.by
#            , conf.int = TRUE, risk.table = TRUE, pval = TRUE
