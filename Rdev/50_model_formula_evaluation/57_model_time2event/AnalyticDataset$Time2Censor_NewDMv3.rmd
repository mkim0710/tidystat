...
as1_7.na.Date.fct.cumulative_DM.list |> str(max.level = 2, give.attr = TRUE)
as1_7.na.Date.fct.cumulative_DM.list$EverDMv3_byWavei |> str(max.level = 2, give.attr = TRUE)
as1_7.na.Date.fct.cumulative_DM.list$NewDMv3_atWavei |> str(max.level = 2, give.attr = TRUE)
# > as1_7.na.Date.fct.cumulative_DM.list |> str(max.level = 2, give.attr = TRUE)
# List of 9
#  $ DM_C            :List of 2
#   ..$ df_wave           : tibble [10,030 × 7] (S3: tbl_df/tbl/data.frame)
