...
set.seed(1)    # Setting a random seed ensures that whenever you run the code, you will get the same results. Without any random seed, the results will change every time you run.
...
set.seed(1)
function.MatchingPairID_Exposed_Unexposed_shuffle_vec(nhanes.fish.match.rename) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_Exposed_Unexposed_shuffle_vec(nhanes.fish.match.rename) |> str(max.level = 2, give.attr = TRUE)
# > function.MatchingPairID_Exposed_Unexposed_shuffle_vec(nhanes.fish.match.rename) |> str(max.level = 2, give.attr = TRUE)
...
# > iteration = 500
# > time2 - time1
# Time difference of 3.283378 secs
# > sum(dist > diff(by(data$Outcome, data$isExposed, mean)) )/iteration  # one-tailed test
# [1] 0.024
# > sum(abs(dist) > abs(diff(by(data$Outcome, data$isExposed, mean))) )/iteration  # two-tailed test
# [1] 0.054
...
set.seed(1)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID = data) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID = data) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID = data) |> str(max.level = 2, give.attr = TRUE)
# > function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID = data) |> str(max.level = 2, give.attr = TRUE)
...
set.seed(1)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID) |> str(max.level = 2, give.attr = TRUE)
function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID) |> str(max.level = 2, give.attr = TRUE)
# > function.MatchingPairID_isExposed_PERSON_ID_shuffle_vec(MatchingPairID_isExposed_PERSON_ID) |> str(max.level = 2, give.attr = TRUE)
...
# # [1] 0.04855
# > time2 - time1
# Time difference of 3.419959 secs
# > sum(EmpiricalDistributionOfStatisticValue > function.calculate.StatisticValue(data) )/iteration  # one-tailed test
# [1] 0.024
# > sum(abs(EmpiricalDistributionOfStatisticValue) > abs(function.calculate.StatisticValue(data)) )/iteration  # two-tailed test
# [1] 0.054
