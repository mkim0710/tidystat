...
# @@ Rdev/00_base_program/f_vec_named.swap.dev.Rmd  
...
cat("    ________________________________________________________________________    \n")
cat("    ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::    \n")
list.vec.Value_Label %>% map_chr(1) %>% str
list.vec.Value_Label %>% map_chr(2) %>% str
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
list.vec.Value_Label %>% {setNames(map_chr(., 2), map_chr(., 1))}

# Step 3: Create the named vector where Value is the name and ValueLabel is the value
named_vector <- setNames(map_chr(list.vec.Value_Label, 2), map_chr(list.vec.Value_Label, 1))
named_vector
```
...
options(width=120)
# Function to swap names and values in the named vector
f_vec_named.swap <- function(vec_named) {
    names(vec_named) |> setNames(vec_named)
}
...
named_vector
dput(named_vector)
swapped_vector <- f_vec_named.swap(named_vector)
print(swapped_vector)
dput(swapped_vector)
```
