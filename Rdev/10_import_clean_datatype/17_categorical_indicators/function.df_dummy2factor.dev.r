...
.packagename = "tidyverse"; if (!paste0("package:",.packagename) %in% search()) {library(.packagename, character.only = TRUE)}
# model.matrix(~ Species, data = iris) |> str(max.level = 2, give.attr = TRUE)
# # > model.matrix(~ Species, data = iris) |> str(max.level = 2, give.attr = TRUE)
...
# 
# useful::build.x(~ Species, data = iris, contrasts = F) |> str(max.level = 2, give.attr = TRUE)
# # > useful::build.x(~ Species, data = iris, contrasts = F) |> str(max.level = 2, give.attr = TRUE)
...
# 
# library(caret)
# dummyVars(~ Species, data = iris) |> str(max.level = 2, give.attr = TRUE)
# predict(dummyVars(~ Species, data = iris), newdata = iris) |> str(max.level = 2, give.attr = TRUE)
# # > dummyVars(~ Species, data = iris) |> str(max.level = 2, give.attr = TRUE)
# # List of 9
...
iris.Species.dummy |> str(max.level = 2, give.attr = TRUE)
...
iris.Species.dummy %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
iris.Species.dummy |> as.data.frame() %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
...
iris.Species.dummy2 %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
iris.Species.dummy2 |> as.data.frame() %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
...
iris.Species.dummy3 %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
iris.Species.dummy3 |> as.data.frame() %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
...
iris.Species.dummy4 %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
iris.Species.dummy4 |> as.data.frame() %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
...
iris.Species.dummy5 %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
iris.Species.dummy5 |> as.data.frame() %>% function.df_dummy2factor(varname_prefix = "Species.") |> str(max.level = 2, give.attr = TRUE)
