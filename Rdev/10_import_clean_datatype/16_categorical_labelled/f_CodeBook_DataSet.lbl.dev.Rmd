...
if(exists("MetaData")) {
    ...
    if(!identical(.MetaData0, MetaData)) {
        ...
        # cat('env1$env.internal.attach$f_filename.ext.createBackup(backup_from_path_filename.ext = "', .path_file, '", .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)', "  ;  ", sep="")
