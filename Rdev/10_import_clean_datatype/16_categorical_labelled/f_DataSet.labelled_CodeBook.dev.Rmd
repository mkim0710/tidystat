...
tblVarName = MetaData$tblVarName$tblWAVE_VARNAME |>
    ...
    select(VarName, WAVE_VARNAME, Wave, VarName.suffix, VarDescription, VarType, ValueOptions, Select)
...
# @@ Rdev/10_import_clean_datatype/16_categorical_labelled/f_DataSet.labelled_CodeBook.dev.Rmd  
...
f_CodeBook_DataSet.labelled = function(DataSet, tblVarName_VarDescription_ValueOptions, NameValuePair_separator = ",", Name_Value_separator = "=", vecNamed.swap = FALSE, VERBOSE = getOption("verbose")) {
