...
env1$path$CurrentSource.path_filename.MetaData.rds = env1$path$CurrentSource.path_filename.ext |> str_replace("\\.([[:alnum:]]+)$",".MetaData.rds")
if(file.exists(env1$path$CurrentSource.path_filename.MetaData.rds)) { 
    MetaData = env1$path$CurrentSource.path_filename.MetaData.rds |> read_rds() 
} else {
...
if(exists("MetaData")) {
    ...
    if(!identical(.MetaData0, MetaData)) {
        # cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
        .path_file = env1$path$CurrentSource.path_filename.MetaData.rds %>% {paste0(env1$path$path1,"/",.)}
