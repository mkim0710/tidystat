...
.sourcename = "f_df.add_BMI.4category" |> paste0(".source.r")
...
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "f_df.add_BMI.4category" |> paste0(".source.r") |> source() ----  
...
for(i in 1:7) {
    DataSet.Date.NA.rmAllNA =
        ...
        env1$f$f_df.add_BMI.4category(varname_BMI = paste0("A0",i,"_","BMI"))
}
