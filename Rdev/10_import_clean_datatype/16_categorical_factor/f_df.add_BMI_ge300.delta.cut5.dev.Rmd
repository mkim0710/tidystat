...
f_df.add_RegEx.cut <- function(DataSet.Date.NA.rmAllNA, regex_pattern = ".", breaks = c(-Inf, -0.1, -0.05, 0.05, 0.1, Inf), suffix = paste0(".cut",length(breaks)-1)) {
...
DataSet.Date.NA.rmAllNA <- f_df.add_RegEx.cut(DataSet.Date.NA.rmAllNA, regex_pattern = "\\.pd[1-6]$", breaks = c(-Inf, -0.1, -0.05, 0.05, 0.1, Inf))
