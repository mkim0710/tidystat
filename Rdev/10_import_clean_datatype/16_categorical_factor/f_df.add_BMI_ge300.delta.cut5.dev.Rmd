...
f_df.add_pdj.cut5 <- function(DataSet.Date.NA.rmAllNA, regex_pattern = "\\.pd[1-6]$", suffix = ".cut5") {
  
  # Ensure that the DataSet.Date.NA.rmAllNA parameter is a data frame
  ...
  # Return the modified DataSet.Date.NA.rmAllNA
  return(DataSet.Date.NA.rmAllNA)
}

# Example usage of the function
# Assuming DataSet.Date.NA.rmAllNA is already loaded and processed up to the point where pdj columns exist

# Call the function to add pdj.cut5 variables
DataSet.Date.NA.rmAllNA <- f_df.add_pdj.cut5(DataSet.Date.NA.rmAllNA)
