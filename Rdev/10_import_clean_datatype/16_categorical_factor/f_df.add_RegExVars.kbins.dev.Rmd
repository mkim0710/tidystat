...
#     }
# }
# DataSet.Date.NA.rmAllNA %>% select(matches("BMI")) %>% select(matches("A03")) |> str(max.level = 2, give.attr = TRUE)
```
...
#     .names = "{.col}.5bins"
#   ))
# DataSet.Date.NA.rmAllNA %>% select(matches(paste0(.RegEx2match, "\\.5bins$"))) %>% summary
```
