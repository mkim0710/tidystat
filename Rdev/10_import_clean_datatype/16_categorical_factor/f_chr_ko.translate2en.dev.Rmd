...
translate_korean_to_english <- function(korean_text) {
  ...
  # Authorize Google Sheets access (interactive)
  ...
  sheet_write(korean_text, sheet, range = "A1")
  
  # Use the GOOGLETRANSLATE function in the next cell (B1)
  translate_formula <- '=GOOGLETRANSLATE(A1, "ko", "en")'
  sheet_write(translate_formula, sheet, range = "B1")
  
  # Read the translated text from the Google Sheet
  translated_text <- sheet_read(sheet1, range = "B1", col_names = FALSE)
  
  # Clean up by deleting the Google Sheet (optional)
  gs4_delete(sheet)2
