...
DataSet.DNR <- env1$f$f_df.add_RegExVars.kbins(DataSet.DNR, regex_pattern = "\\.pdelta[1-6]$", breaks = c(-Inf, -0.1, -0.05, 0.05, 0.1, Inf))
DataSet.DNR %>% select(matches("\\.pdelta[1-6]\\.cut")) %>% summary
