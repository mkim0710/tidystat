...
DataSet.Date.NA.rmAllNA <- env1$f$f_df.add_RegExVars.kbins(DataSet.Date.NA.rmAllNA, regex_pattern = "\\.pdelta[1-6]$", breaks = c(-Inf, -0.1, -0.05, 0.05, 0.1, Inf))
DataSet.Date.NA.rmAllNA %>% select(matches("\\.pdelta[1-6]\\.cut")) %>% summary
