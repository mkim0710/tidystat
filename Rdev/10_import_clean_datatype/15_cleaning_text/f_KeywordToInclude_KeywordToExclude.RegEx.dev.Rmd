...
sentences <- c(
  "This sentence contains KeywordToInclude but not the other keyword.",
  "This sentence contains both KeywordToInclude and KeywordToExclude.",
  "This sentence contains KeywordToExclude but not the included keyword.",
  "This sentence contains neither of the keywords.",
  "KeywordToInclude is here, and so is KeywordToExclude.",
  "Only KeywordToInclude is present here.",
  "Only KeywordToExclude is present here.",
  "KeywordToInclude appears twice: KeywordToInclude.",
  "KeywordToIncludeKeywordToExclude is one word.",
  "KeywordToExcludeKeywordToInclude is one word.",
  "This sentence contains KeywordToInclude with KeywordToExclude somewhere else."
)
```
...
## https://chatgpt.com/c/670880b0-b908-800e-97b1-32905ac29fcf

### ECHO \% |> grepl() ----  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="#", R.options=list(width=120)}
# Define the two regex patterns
pattern1 <- "^(?!.*\\bKeywordToExclude\\b).*(\\bKeywordToInclude\\b).*$"
pattern2 <- "^(?!.*\\bKeywordToExclude\\b).*?\\bKeywordToInclude\\b(?!.*\\bKeywordToExclude\\b)"

# Apply the patterns to the sentences
matches_pattern1 <- grepl(pattern1, sentences, perl = TRUE)
matches_pattern2 <- grepl(pattern2, sentences, perl = TRUE)

# Display the results
results <- data.frame(
  Sentence = sentences,
  Matches_Pattern1 = matches_pattern1,
  Matches_Pattern2 = matches_pattern2
)
...
```
    ...
    # 1. "This sentence contains KeywordToInclude but not the other keyword."
    # Contains KeywordToInclude: Yes
    # Contains KeywordToExclude: No
    # Expected Match: Yes (for both patterns)
    # 2. "This sentence contains both KeywordToInclude and KeywordToExclude."
    # Contains KeywordToInclude: Yes
    # Contains KeywordToExclude: Yes
    # Expected Match: No (excluded because it contains KeywordToExclude)
    # 3. "This sentence contains KeywordToExclude but not the included keyword."
    # Contains KeywordToInclude: No
    # Contains KeywordToExclude: Yes
    # Expected Match: No (does not contain KeywordToInclude, and contains KeywordToExclude)
    # 4. "This sentence contains neither of the keywords."
    # Contains KeywordToInclude: No
    # Contains KeywordToExclude: No
    # Expected Match: No (does not contain KeywordToInclude)
    # 5. "KeywordToInclude is here, and so is KeywordToExclude."
    # Contains KeywordToInclude: Yes
    # Contains KeywordToExclude: Yes
    # Expected Match: No (excluded because it contains KeywordToExclude)
    # 6. "Only KeywordToInclude is present here."
    # Contains KeywordToInclude: Yes
    # Contains KeywordToExclude: No
    # Expected Match: Yes (for both patterns)
    # 7. "Only KeywordToExclude is present here."
    # Contains KeywordToInclude: No
    # Contains KeywordToExclude: Yes
    # Expected Match: No (does not contain KeywordToInclude, and contains KeywordToExclude)
    # 8. "KeywordToInclude appears twice: KeywordToInclude."
    # Contains KeywordToInclude: Yes (twice)
    # Contains KeywordToExclude: No
    # Expected Match: Yes (for both patterns)
    # 9. "KeywordToIncludeKeywordToExclude is one word."
    # Contains KeywordToInclude as a whole word: No
    # Contains KeywordToExclude as a whole word: No
    # Expected Match: No (keywords are not matched as whole words)
    # 10. "KeywordToExcludeKeywordToInclude is one word."
    # Contains KeywordToInclude as a whole word: No
    # Contains KeywordToExclude as a whole word: No
    # Expected Match: No (keywords are not matched as whole words)
    # 11. "This sentence contains KeywordToInclude with KeywordToExclude somewhere else."
    # Contains KeywordToInclude: Yes
    # Contains KeywordToExclude: Yes
    # Expected Match: No (excluded because it contains KeywordToExclude)

  
## https://gemini.google.com/app/a2536f31ebfc3766
...
# Sample text
text <- c(
  "This sentence has KeywordToInclude.",
  "This one has KeywordToExclude before KeywordToInclude.",
  "This has KeywordToInclude, but KeywordToExclude is after.",
  "This has KeywordToInclude but not KeywordToExclude."
)

# Option 1: Alternation within negative lookahead
pattern1 <- "^(?!.*(\\bKeywordToExclude\\b.*\\bKeywordToInclude\\b|\\bKeywordToInclude\\b.*\\bKeywordToExclude\\b)).*\\bKeywordToInclude\\b.*$"
str_detect(text, pattern1)
# Expected output: TRUE FALSE FALSE TRUE

# Option 2: Repeated negative lookahead
pattern2 <- "^(?!.*\\bKeywordToExclude\\b).*?\\bKeywordToInclude\\b(?!.*\\bKeywordToExclude\\b)"
str_detect(text, pattern2)
# Expected output: TRUE FALSE FALSE TRUE
```
