...
function.character.clean = function(vec, pattern_to_clean = "[^A-Za-z0-9[:punct:][:space:]]") {
...
# function.character.clean(vec, pattern_to_clean = "[^A-Za-z0-9]")
# function.character.clean(vec, pattern_to_clean = "[^A-Za-z0-9[:punct:]]")
# function.character.clean(vec, pattern_to_clean = "[^A-Za-z0-9[:space:]]")
# # > function.character.clean(vec, pattern_to_clean = "[^A-Za-z0-9]")
# #        2   3   5         13       14                      15                  
# # Before " " "." "Period." "a\\n b" "Now is the time      " "\tMillard Fillmore"
