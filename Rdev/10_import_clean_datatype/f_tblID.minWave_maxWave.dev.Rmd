...
# @@ update default notebook.Rmd ----  
# filename_ext = file.path(env1$path$source_base_local,"Rproject_Rmd","00env1.minimum.Rmd")
filename_ext = "templates-00env1.minimum.Rmd"; if(file.exists(filename_ext)) {
    ...
    if(file.copy(from=filename_ext, to=file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"), overwrite=TRUE)) message(paste0("Update successful: ", file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) else message(paste0("Update failed: ", file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) 
