...
# @@ update default notebook.Rmd ----  
# FileNameExt = here::here(env1$path$source_base_local,"Rproject_Rmd","00env1.minimum.Rmd")
FileNameExt = "templates-00env1.minimum.Rmd"; if(file.exists(FileNameExt)) {
    ...
    if(file.copy(from=FileNameExt, to=here::here(.path4APPDATA_RStudio, "templates", "notebook.Rmd"), overwrite=TRUE)) message(paste0("Update successful: ", here::here(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) else message(paste0("Update failed: ", here::here(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) 
    file.edit(here::here(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))
}
