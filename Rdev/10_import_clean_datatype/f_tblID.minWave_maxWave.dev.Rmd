...
# @@ update default notebook.Rmd ----  
# FileNameExt = file.path(env1$path$source_base_local,"Rproject_Rmd","00env1.minimum.Rmd")
FileNameExt = "templates-00env1.minimum.Rmd"; if(file.exists(FileNameExt)) {
    ...
    if(file.copy(from=FileNameExt, to=file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"), overwrite=TRUE)) message(paste0("Update successful: ", file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) else message(paste0("Update failed: ", file.path(.path4APPDATA_RStudio, "templates", "notebook.Rmd"))) 
