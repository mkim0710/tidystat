...
data %>% map(~function.apply_ExpressionText(.x, ExpressionText)) |> str(max.level = 2, give.attr = TRUE)
data %>% map_df(~function.apply_ExpressionText(.x, ExpressionText)) |> str(max.level = 2, give.attr = TRUE)
data %>% map_df(~tibble(function.apply_ExpressionText(.x, ExpressionText))) |> str(max.level = 2, give.attr = TRUE)
data %>% map_df(~unname(function.apply_ExpressionText(.x, ExpressionText))) |> str(max.level = 2, give.attr = TRUE)
data %>% mutate_all(function.apply_ExpressionText, ExpressionText) |> str(max.level = 2, give.attr = TRUE)
