...
if (.Platform$OS.type == "windows" && Sys.getenv("PARENT_RENDERING") != "YES") { paste0('ping -n 3 127.0.0.1 > nul & "C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe" --app="',env1$path$CurrentSource.path.filename.nb.html|>normalizePath(winslash="/"),'"') |> shell(wait=FALSE) } # else { browseURL(env1$path$CurrentSource.path.filename.nb.html) }
