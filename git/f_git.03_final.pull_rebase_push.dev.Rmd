...
header-includes: 
  - \usepackage{fontspec}
  - \setmainfont{Roboto Serif}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={Noto Serif}]
  - \setsansfont{Roboto Condensed}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={Noto Sans Condensed}]
