...
header-includes: 
  - \usepackage{fontspec}
  - \setmainfont{Roboto}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={Noto Serif}]
  - \setsansfont{Arial}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={Helvetica}]
  - \setmonofont{Cascadia Code SemiBold}[FallbackFamilies={Cascadia Code}]
  - \usepackage[hangul]{kotex}
  - \setmainhangulfont{NanumMyeongjo}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={HCR Batang}]
  - \setsanshangulfont{NanumGothic}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamilies={HCR Dotum}]
  - \setmonohangulfont{D2Coding}[FallbackFamilies={Cascadia Code}]
params:
...
h1.title { font-size: 28px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 14px; margin-bottom: 0; color: Navy; }
h1 { font-size: 24px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 12px; margin-bottom: 0; color: Navy; }
h2 { font-size: 21px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 11px; margin-bottom: 0; color: Navy; }
h3 { font-size: 18px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 9px; margin-bottom: 0; color: Navy; }
h4 { font-size: 16px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 8px; margin-bottom: 0; color: Navy; }
h5 { font-size: 14px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 7px; margin-bottom: 0; color: Navy; }
h6 { font-size: 12px; font-family: 'Roboto', 'Noto Serif', serif; line-height: 1.1; margin-top: 6px; margin-bottom: 0; color: Navy; }
