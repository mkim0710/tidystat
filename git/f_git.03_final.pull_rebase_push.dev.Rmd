...
header-includes: 
  - \usepackage{fontspec}
  - \setmainfont{Roboto Serif}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamily={Noto Serif}]
  - \setsansfont{Roboto Condensed}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamily={Noto Sans Condensed}]
  - \setmonofont{Cascadia Code SemiBold}[FallbackFamily={Cascadia Code}]
  - \usepackage[hangul]{kotex}
  - \setmainhangulfont{NanumMyeongjo}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamily={HCR Batang}]
  - \setsanshangulfont{NanumGothic}[Ligatures={Common, TeX, NoRequired, NoContextual, NoHistorical}, FallbackFamily={HCR Dotum}]
  - \setmonohangulfont{D2Coding}[FallbackFamily={Cascadia Code}]
params:
