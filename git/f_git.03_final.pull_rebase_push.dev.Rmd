...
LastSourceEditorContext.path_FileNameExt=rstudioapi::getSourceEditorContext()$path; if(basename(LastSourceEditorContext.path_FileNameExt) == template.FileNameExt) {
    ...
    for ( .destination_path_FileNameExt in c(
        ...
        BACKUP.path_FileName = here::here(env1$path$path0, "Rproject_Rmd", "-BACKUP", paste0(destination.FileName,"-",format(Sys.time(),"%y%m%dT%H%M"),destination.ext))
...
# template.FileNameExt = "notebook.Rmd"; if(!file.exists(here::here(.path4APPDATA_RStudio, "templates", template.FileNameExt))) file.create(here::here(.path4APPDATA_RStudio, "templates", template.FileNameExt)); file.edit(here::here(.path4APPDATA_RStudio, "templates", template.FileNameExt))
```
