...
header-includes: 
  ...
  - \setfallbackfont{\setmonohangulfont}{D2Coding}{Cascadia Code SemiBold}{Fira Code}
params:
...
if (.Platform$OS.type == "windows") { paste0('"C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe" --app="',env1$path$CurrentSource.path.filename.nb.html|>normalizePath(winslash="/"),'"') |> system(intern=TRUE) } # else { browseURL(env1$path$CurrentSource.path.filename.nb.html) }
# paste0("https://github.com/mkim0710/",basename(getwd()),"/blob/main/",env1$path$CurrentSource.path.filename.ext) |> browseURL()
# paste0("https://github.com/mkim0710/",basename(getwd()),"/commits/main/",env1$path$CurrentSource.path.filename.ext) |> browseURL()
paste0("https://github.com/mkim0710/",basename(getwd()),"/blob/main/",env1$path$CurrentSource.path.filename.ext) %>% paste0('"',.,'" |> browseURL()') |> cat("\n")
paste0("https://github.com/mkim0710/",basename(getwd()),"/commits/main/",env1$path$CurrentSource.path.filename.ext) %>% paste0('"',.,'" |> browseURL()') |> cat("\n")
