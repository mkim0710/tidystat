...
# Example paths
path_last <- "D:/OneDrive/[][Rproject]/[code]-github_tidystat@abc/a/b/c"
path0 <- "D:/OneDrive/[][Rproject]"

path_last |> str_replace(fixed(path0), "")
path_last |> str_replace(fixed(path0), "") |> str_replace("^/", "")
path_last |> str_replace(fixed(path0), "") |> str_extract("^/[^/]+")
path_last |> str_replace(fixed(path0), "") |> str_extract("[^/]+")
```
...
env1$path$getwd |> str_replace(fixed(env1$path$path0), "") |> str_extract("[^/]+") |> normalizePath(winslash="/")
