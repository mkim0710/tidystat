...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) write_rds.git_lfs_track_add_f.based_on_size  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "write_rds.git_lfs_track_add_f.based_on_size")
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(.objectname, .path4write, as_table=TRUE, table_style="none", row_names=TRUE, col_widths="auto", first_active_row=2, first_active_col=2, windows_path_changed_from = "^D:/D_Repositories", windows_path_changed_to = "D:/OneDrive/[][Rproject]", open_xlsx = TRUE) {
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(.objectname, .path4write, windows_path_changed_from = "^D:/D_Repositories", windows_path_changed_to = "D:/OneDrive/[][Rproject]", open_xlsx = TRUE, archive_to_xz = TRUE) {
  ...
  if (open_xlsx && Sys.info()["sysname"] == "Windows") {
      ...
      readr::write_excel_csv(get(.objectname), file = .path_FileName.UTF8BOM.csv|>paste0(ifelse(archive_to_xz, ".xz", ""))) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
  }
...
.tmp$env1_subenv_name = "f"
.tmp$objectname = "f.generateText4FileNameBase"
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(prefix = "", suffix = "") {
    BaseName = tryCatch({
        tools::file_path_sans_ext(basename(rstudioapi::getSourceEditorContext()$path))
    }, error = function(e) {
        "BaseName"
    })
    paste0(prefix, BaseName, suffix)
}
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) FileNameBase  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "FileNameBase")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) BaseFileName  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "BaseFileName")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) BaseName  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "BaseName")
