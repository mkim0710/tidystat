...
## \% env1$f$f_DataSetName.read.checkEntity(print2console = FALSE) =======  
...
## \% env1$f$f_DataSetName.read.checkEntity(vec_varname4ID = "randid", print2console = FALSE) =======  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
...
## \% f_DataSetName.read.checkEntity(print2console = TRUE) =======  
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
out = env1$f$f_DataSetName.read.checkEntity(DataSetName = DataSetName, vec_varname4ID = "randid", print2console = TRUE)
```
...
```{r, echo=-1, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
env1$f$f_DataSetName.read.checkEntity(DataSetName = DataSetName, vec_varname4ID = "randid", print2console = TRUE, return.output = TRUE)
```
