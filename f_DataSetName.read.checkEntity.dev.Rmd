...
## \% f_DataSetName.Search.read.checkEntity(print2console = FALSE) =======  
...
out %>% str
# Warning messages:
# 1: In env1$f$f_DataSetName.Search.read.checkEntity(DataSetName = .objectname) :
#   getwd() != .path4read == "."
# 2: In env1$f$f_DataSetName.Search.read.checkEntity(DataSetName = .objectname) :
#   varname for ID not identified among: c("ID", "CompositeKey", "PERSON_ID", "RN_INDI", "NIHID")
```
  
  
  
## \% f_DataSetName.Search.read.checkEntity(vec_candidate4ID = "randid", print2console = FALSE) =======  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
...
## \% f_DataSetName.Search.read.checkEntity(print2console = TRUE, return.output = FALSE) =======  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
env1$f$f_DataSetName.Search.read.checkEntity(DataSetName = DataSetName, vec_candidate4ID = "randid", print2console = TRUE, return.output = FALSE)
```
  
  
## \% f_DataSetName.Search.read.checkEntity(print2console = TRUE, return.output = TRUE) =======  
```{r, echo=TRUE, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
options(width=120)
env1$f$f_DataSetName.Search.read.checkEntity(DataSetName = DataSetName, print2console = TRUE, return.output = TRUE)
```
