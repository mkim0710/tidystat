...
'fc-list : family' |> system(intern = TRUE) |> sort() |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find / -type d -iname texlive' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("/usr/local/texlive",  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find / -type d -iname texmf-dist' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type d -iname "fontspec"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type d -iname "fontspec"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type d -iname "roboto"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type d -iname "roboto"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type d -iname "cascadia*code"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type d -iname "cascadia*code"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type d -iname "font[s ]"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type d -iname "font[s ]"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("afm/",  
  "cid/",  
  "cmap/",  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/opentype' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/opentype' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("google/",  
  "public/")  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/opentype/public' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/opentype/public' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("cascadia-code/",  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/opentype/google' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/opentype/google' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("roboto/")  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/opentype/google/roboto' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/opentype/google/roboto' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/truetype' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/truetype' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
c("")  
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/truetype/public' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/truetype/public' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/truetype/google' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/truetype/google' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'ls -F /usr/share/texlive/texmf-dist/fonts/truetype/google/roboto' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'ls -F /usr/local/texlive/texmf-dist/fonts/truetype/google/roboto' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type f -iname "*roboto*mono*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type f -iname "*roboto*mono*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type d -iname "*inconsolata*"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type d -iname "*inconsolata*"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type f -iname "*inconsolata*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type f -iname "*inconsolata*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
...
```{r, results="markup", collapse=TRUE, paged.print=FALSE, comment="", R.options=list(width=120)}
'find /usr/share/texlive -type f -iname "*cascadia*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
'find /usr/local/texlive -type f -iname "*cascadia*.?tf"' |> system(intern = TRUE) |> env1$f_vec.dput_line_by_line()
```
