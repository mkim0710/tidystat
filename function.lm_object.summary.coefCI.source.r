...
function.lm_object.summary.coefCI = function(lm_object, sprintf_fmt_decimal = 2) {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
...
# > function.lm_object.summary.coefCI(lm_object)
#        rowname                   coefCI p_value star      Estimate         2.5 %        97.5 %  Std. Error      t value     Pr(>|t|)
# 1  (Intercept)  36.46 ( 26.43 ~  46.49)  <0.001  ***  3.645949e+01  26.432226009  46.486750761 5.103458811   7.14407419 3.283438e-12
# 2         crim  -0.11 ( -0.17 ~  -0.04)   0.001  **  -1.080114e-01  -0.172584412  -0.043438304 0.032864994  -3.28651687 1.086810e-03
# 3           zn   0.05 (  0.02 ~   0.07)  <0.001  ***  4.642046e-02   0.019448778   0.073392139 0.013727462   3.38157628 7.781097e-04
# 4        indus   0.02 ( -0.10 ~   0.14)   0.738       2.055863e-02  -0.100267941   0.141385193 0.061495689   0.33431004 7.382881e-01
# 5         chas   2.69 (  0.99 ~   4.38)   0.002  **   2.686734e+00   0.993904193   4.379563446 0.861579756   3.11838086 1.925030e-03
# 6          nox -17.77 (-25.27 ~ -10.26)  <0.001  *** -1.776661e+01 -25.271633564 -10.261588893 3.819743707  -4.65125741 4.245644e-06
# 7           rm   3.81 (  2.99 ~   4.63)  <0.001  ***  3.809865e+00   2.988726773   4.631003640 0.417925254   9.11614020 1.979441e-18
# 8          age   0.00 ( -0.03 ~   0.03)   0.958       6.922246e-04  -0.025262320   0.026646769 0.013209782   0.05240243 9.582293e-01
# 9          dis  -1.48 ( -1.87 ~  -1.08)  <0.001  *** -1.475567e+00  -1.867454981  -1.083678710 0.199454735  -7.39800360 6.013491e-13
# 10         rad   0.31 (  0.18 ~   0.44)  <0.001  ***  3.060495e-01   0.175692169   0.436406789 0.066346440   4.61289977 5.070529e-06
# 11         tax  -0.01 ( -0.02 ~  -0.00)   0.001  **  -1.233459e-02  -0.019723286  -0.004945902 0.003760536  -3.28000914 1.111637e-03
# 12     ptratio  -0.95 ( -1.21 ~  -0.70)  <0.001  *** -9.527472e-01  -1.209795296  -0.695699168 0.130826756  -7.28251056 1.308835e-12
# 13       black   0.01 (  0.00 ~   0.01)  <0.001  ***  9.311683e-03   0.004034306   0.014589060 0.002685965   3.46679256 5.728592e-04
# 14       lstat  -0.52 ( -0.62 ~  -0.43)  <0.001  *** -5.247584e-01  -0.624403622  -0.425113133 0.050715278 -10.34714580 7.776912e-23



function.glm_object.summary.OR = function(glm_object, sprintf_fmt_decimal = 2, coef.exp = T) {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
...
#       rowname               ORCI p_value star exp(Estimate)  exp(2.5 %) exp(97.5 %)  Std. Error   z value     Pr(>|z|)
# 1 (Intercept) 0.03 (0.00 ~ 0.28)   0.002  **     0.03175998 0.003309497   0.2835650 1.132846009 -3.045029 2.326583e-03
# 2         gre 1.00 (1.00 ~ 1.00)   0.036  *      1.00229659 1.000171559   1.0044714 0.001091839  2.101005 3.564052e-02
# 3         gpa 2.17 (1.15 ~ 4.17)   0.018  *      2.17496718 1.152082367   4.1717746 0.327483878  2.372677 1.765968e-02
# 4        rank 0.57 (0.44 ~ 0.73)  <0.001  ***    0.57119114 0.442656492   0.7294389 0.127136989 -4.404945 1.058109e-05
...
function.coxph_object.summary.OR = function(coxph_object, sprintf_fmt_decimal = 2, coef.exp = T, is.clogit = "unknown") {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
