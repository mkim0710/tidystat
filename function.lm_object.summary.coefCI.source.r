...
function.lm_object.summary.coefCI = function(lm_object, sprintf_fmt_decimal = 2, p.adjust_method = c("bonferroni", "fdr")) {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
    ...
    for (i in 1:length(p.adjust_method)) {
        ...
        tmp.df[[p.adjust_method.i]] = sprintf("%.3f", tmp.df[[paste0("p.adjust.", i)]])
        tmp.df[[p.adjust_method.i]] [tmp.df[[paste0("p.adjust.", i)]] <= 0.001] = "<0.001"
...
# > function.lm_object.summary.coefCI(lm_object)
#        rowname                   coefCI p_value star    bon *bon    fdr *fdr      Estimate         2.5 %        97.5 %  Std. Error      t value     Pr(>|t|)
...
# 2         crim  -0.11 ( -0.17 ~  -0.04)   0.001  **   0.015  *    0.001  **  -1.080114e-01  -0.172584412  -0.043438304 0.032864994  -3.28651687 1.086810e-03
# 3           zn   0.05 (  0.02 ~   0.07)  <0.001  ***  0.011  *    0.001  **   4.642046e-02   0.019448778   0.073392139 0.013727462   3.38157628 7.781097e-04
# 4        indus   0.02 ( -0.10 ~   0.14)   0.738       1.000       0.795       2.055863e-02  -0.100267941   0.141385193 0.061495689   0.33431004 7.382881e-01
# 5         chas   2.69 (  0.99 ~   4.38)   0.002  **   0.027  *    0.002  **   2.686734e+00   0.993904193   4.379563446 0.861579756   3.11838086 1.925030e-03
...
# 8          age   0.00 ( -0.03 ~   0.03)   0.958       1.000       0.958       6.922246e-04  -0.025262320   0.026646769 0.013209782   0.05240243 9.582293e-01
...
# 11         tax  -0.01 ( -0.02 ~  -0.00)   0.001  **   0.016  *    0.001  **  -1.233459e-02  -0.019723286  -0.004945902 0.003760536  -3.28000914 1.111637e-03
# 12     ptratio  -0.95 ( -1.21 ~  -0.70)  <0.001  *** <0.001  *** <0.001  *** -9.527472e-01  -1.209795296  -0.695699168 0.130826756  -7.28251056 1.308835e-12
# 13       black   0.01 (  0.00 ~   0.01)  <0.001  ***  0.008  **   0.001  **   9.311683e-03   0.004034306   0.014589060 0.002685965   3.46679256 5.728592e-04
# 14       lstat  -0.52 ( -0.62 ~  -0.43)  <0.001  *** <0.001  *** <0.001  *** -5.247584e-01  -0.624403622  -0.425113133 0.050715278 -10.34714580 7.776912e-23


function.glm_object.summary.OR = function(glm_object, sprintf_fmt_decimal = 2, coef.exp = T, p.adjust_method = c("bonferroni", "fdr")) {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
...
#       rowname               ORCI p_value star    bon *bon    fdr *fdr exp(Estimate)  exp(2.5 %) exp(97.5 %)  Std. Error   z value     Pr(>|z|)
# 1 (Intercept) 0.03 (0.00 ~ 0.28)   0.002  **   0.009  **   0.005  **     0.03175998 0.003309497   0.2835650 1.132846009 -3.045029 2.326583e-03
# 2         gre 1.00 (1.00 ~ 1.00)   0.036  *    0.143       0.036  *      1.00229659 1.000171559   1.0044714 0.001091839  2.101005 3.564052e-02
# 3         gpa 2.17 (1.15 ~ 4.17)   0.018  *    0.071       0.024  *      2.17496718 1.152082367   4.1717746 0.327483878  2.372677 1.765968e-02
...
function.coxph_object.summary.OR = function(coxph_object, sprintf_fmt_decimal = 2, coef.exp = T, is.clogit = "unknown", p.adjust_method = c("bonferroni", "fdr")) {
    # source("https://github.com/mkim0710/tidystat/raw/master/function.lm_object.summary.coefCI.source.r")
...
#   X matrix deemed to be singular; variable 9
# > clogit_object %>% function.coxph_object.summary.OR
#                      rowname               ORCI p_value star    bon *bon    fdr *fdr    exp(coef)   exp(2.5 %) exp(97.5 %)   se(coef)          z     Pr(>|z|)
# 1                   toccfarm 0.15 (0.01 ~ 2.25)   0.170       1.000       0.170      0.1500985887 1.002427e-02  2.24750455 1.38078224  -1.373470 1.696063e-01
# 2             toccoperatives 3.21 (1.06 ~ 9.73)   0.039  *    0.313       0.045  *   3.2115387998 1.059825e+00  9.73178121 0.56564649   2.062684 3.914262e-02
...
# 6         toccfarm:education 0.69 (0.55 ~ 0.87)   0.001  **   0.012  *    0.002  **  0.6905369692 5.496656e-01  0.86751158 0.11640997  -3.180877 1.468301e-03
