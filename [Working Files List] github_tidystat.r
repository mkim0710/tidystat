...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
# .filename.r = "function.detachAllPackages" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.r = "function.detachAllPackages.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
.filename.r = "Encoding.txt"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.r = "options.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.r = "function.update.Rprofile.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.r = "function.Sys.setenv.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
.filename.r = "f_clipboard_path_BackSlash.to_URL.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  

### \% f_path -----  
#### \% internal.f_path0.list_path_hierarchy -----  
.filename.r = "internal.f_path0.list_path_hierarchy" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.list_subpath -----  
.filename.r = "f_path.list_subpath" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.df_dirs_recursive.df_files -----  
.filename.r = "f_path.df_dirs_recursive.df_files" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
### \% f_file -----  
#### \% f_filename_ext.find_subpath -----  
.filename.r = "f_filename_ext.find_subpath" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.size_files -----  
.filename.r = "f_path.size_files" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
.filename.r = "f_DSN.Search.read.checkEntity" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.r = paste0(.relative.subpath,ifelse(.relative.subpath=="","","/"),.filename.r); file.path(env1$path$source_base, .relative.subpath_filename.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
