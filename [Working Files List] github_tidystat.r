...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
# .filename.source.r = "function.detachAllPackages" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.source.r = "function.detachAllPackages.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
.filename.source.r = "Encoding.txt"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.source.r = "options.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.source.r = "function.update.Rprofile.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
.filename.source.r = "function.Sys.setenv.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
.filename.source.r = "f_clipboard_path_BackSlash.to_URL.dev.r"; .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  

### \% f_path -----  
#### \% internal.f_path0.list_path_hierarchy -----  
.filename.source.r = "internal.f_path0.list_path_hierarchy" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.list_subpath -----  
.filename.source.r = "f_path.list_subpath" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.df_dirs_recursive.df_files -----  
.filename.source.r = "f_path.df_dirs_recursive.df_files" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
### \% f_file -----  
#### \% f_filename_ext.find_subpath -----  
.filename.source.r = "f_filename_ext.find_subpath" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
#### \% f_path.size_files -----  
.filename.source.r = "f_path.size_files" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
.filename.source.r = "f_DSN.Search.read.checkEntity" |> paste0(c(".source.r",".dev.r")); .relative.subpath=r"()"|>str_replace_all("\\\\","/"); .relative.subpath_filename.source.r = file.path(.relative.subpath, .filename.source.r); file.path(env1$path$source_base, .relative.subpath_filename.source.r) %>% {.[file.exists(.)]} |> file.edit(); if(!is.null(env1$path$LastSourceEditorContext.path_filename_ext)) if(env1$path$LastSourceEditorContext.path_filename_ext != "") file.edit(paste0(env1$path$path1,"/",env1$path$LastSourceEditorContext.path_filename_ext))
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
