...
# file.edit("D:/OneDrive/[][Rproject]/github_tidystat/rstudio-prefs/templates/f_df.t.tribble_construct.dev.r"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));  
# file.edit("D:/OneDrive/[][Rproject]/github_tidystat/rstudio-prefs/templates/f_df.t.tribble_construct.dev.Rmd"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));  
# file.edit("D:/OneDrive/[][Rproject]/github_tidystat/rstudio-prefs/templates/f_df.t.tribble_construct.source.r"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
# .CurrentSource.path_filename.ext = rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/") |> str_replace(fixed(getwd()|>normalizePath(winslash="/")), "") |> str_replace("^/", "")
...
# if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") {.subpath = .CurrentSource.path_filename.ext |> dirname(); ".subpath" %>% {cat(.,' = "',get(.),'"  \n', sep="")} }
# # if(.subpath!="") utils::browseURL(normalizePath(.subpath))
# # .sourcename = "default.template" |> paste0(".source.r")
# if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") {.sourcename = .CurrentSource.path_filename.ext |> basename() |> str_replace("\\.(dev|source)\\.(r|Rmd)$"|>regex(ignore_case=TRUE), "") |> str_replace("\\.(r|Rmd)$"|>regex(ignore_case=TRUE),""); ".sourcename" %>% {cat(.,' = "',get(.),'"  \n', sep="")} }
# #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#     '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_filename.dev.r,'"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));', "  \n",
#     '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_filename.dev.Rmd,'"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));', "  \n",
#     '# file.edit("',env1$path$source_base_local,"/",env1$path$.subpath_filename.source.r,'"); if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext));', "  \n",
#     sep="")
# #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
.tmp$object = function(.CurrentSource.path_filename.ext = env1$path$CurrentSource.path_filename.ext) {
    ...
    if (Sys.info()["sysname"] == "Windows") {
        if(basename(.CurrentSource.path_filename.ext %>% {paste0(env1$path$path1,"/",.)}) == env1$path$MyTemplate.filename.ext) {
            ...
            if(file.copy(from=.CurrentSource.path_filename.ext %>% {paste0(env1$path$path1,"/",.)}, to=.destination_path_filename.ext, overwrite=TRUE)) message(paste0("Update successful: ", .destination_path_filename.ext)) else warning(paste0("Update failed: ", .destination_path_filename.ext))
            ...
            )) {if(dir.exists(dirname(.destination_path_filename.ext)) & .CurrentSource.path_filename.ext %>% {paste0(env1$path$path1,"/",.)}|>normalizePath(winslash="/") != .destination_path_filename.ext) {
                if(file.copy(from=.CurrentSource.path_filename.ext %>% {paste0(env1$path$path1,"/",.)}, to=.destination_path_filename.ext, overwrite=TRUE)) message(paste0("Update successful: ", .destination_path_filename.ext)) else warning(paste0("Update failed: ", .destination_path_filename.ext))
                # if (Sys.info()["sysname"] == "Windows") {shell( paste0("notepad.exe"," ",shQuote(.destination_path_filename.ext)), wait=FALSE )} # else if (.Platform$OS.type == "unix") {system(paste0("open -a TextEdit ",.destination_path_filename.ext),wait=FALSE)}  
            }}
            if(!is.null(.CurrentSource.path_filename.ext)) if(.CurrentSource.path_filename.ext != "") file.edit(paste0(env1$path$path1,"/",.CurrentSource.path_filename.ext))
        }
