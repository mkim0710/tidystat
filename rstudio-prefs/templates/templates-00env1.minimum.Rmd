...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
assign( paste0(DataSetName2,".NA"), get(DataSetName2) |> mutate_if(is.factor, as.character) ); MetaData$DataSetNames[[paste0(DataSetName2,".NA")]] = list(DataSetName = paste0(DataSetName2,".NA"))
...
assign( paste0(DataSetName2,".NA",".rmAllNA"), get(paste0(DataSetName2,".NA")) |> select_if(function(vec) !all(is.na(vec))) ); MetaData$DataSetNames[[paste0(DataSetName2,".NA",".rmAllNA")]] = list(DataSetName = paste0(DataSetName2,".NA",".rmAllNA"))
