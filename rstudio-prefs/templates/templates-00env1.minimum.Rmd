...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
DSname.Date.NA = DSname.Date |> paste0(".NA"); assign( DSname.Date.NA, get(DSname.Date) |> mutate_if(is.factor, as.character) ); MetaData$DSNs[[DSname.Date.NA]] = list(DSN = DSname.Date.NA)
...
DSname.DNR = paste0(DSN,".DNR"); assign( DSname.DNR, get(DSname.Date.NA) |> select_if(function(vec) !all(is.na(vec))) ); MetaData$DSNs[[DSname.DNR]] = list(DSN = DSname.DNR)
