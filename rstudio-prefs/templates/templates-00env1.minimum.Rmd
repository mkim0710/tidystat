...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n"); 
DataSetName2.NA = paste0(DataSetName2,".NA"); 
DataSetName2.NA.rmAllNA = paste0(DataSetName2,".NA",".rmAllNA"); 
DataSetName2.NA.rmAllNA.fct = paste0(DataSetName2,".NA",".rmAllNA",".fct"); 
"assign( DataSetName2.NA.rmAllNA.fct, get(DataSetName2.NA.rmAllNA) |> mutate_if(is.character, as.factor) , envir = .GlobalEnv)" |> env1$f$f_CodeText.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4CodeText = "> ", LinePrefix4Output = "") |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
cat("   #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    \n"); 
"get(DataSetName2.NA.rmAllNA.fct) |> select_if(is.factor) |> summary()" |> env1$f$f_CodeText.echo(Execute = TRUE, deparse_cat = FALSE, LinePrefix4CodeText = "> ", LinePrefix4Output = "") |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
