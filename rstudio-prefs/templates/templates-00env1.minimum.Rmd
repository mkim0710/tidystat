...
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
"ADS_time2event.NR |> select_if(is.numeric) |> summary()" |> env1$f$f_CodeText.ECHO(EXECUTE = TRUE, deparse_cat = FALSE, LinePrefix4CodeText = "> ", LinePrefix4Output = "") |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
"ADS_time2event.NR |> select_if(is.logical) |> summary()" |> env1$f$f_CodeText.ECHO(EXECUTE = TRUE, deparse_cat = FALSE, LinePrefix4CodeText = "> ", LinePrefix4Output = "") |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n"); 
DSN.Date.NA = DSN.Date |> paste0(".NA"); 
DSN.DNR = paste0(DSN.Date,".NA",".rmAllNA"); 
DSN.DNR.lbl_pending.fct = paste0(DSN.Date,".NA",".rmAllNA",".fct"); 
...
## :: DSN1.recode.n = paste0(DSN,".Date",".NA",".rmAllNA",".lbl_pending",".fct",".recode",".n",nrow(DS1))
## :: DSN1.recode.n = paste0(DSN,".DNR","".lbl_pending",".fct",".recode",".n",nrow(DSN1.recode.n))
