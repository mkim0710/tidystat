...
.t0 = Sys.time()
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
"analyticDF_time2event.NA.rmAllNA |> select_if(is.numeric) |> summary()" |> env1$f$f_CodeText.echo(Execute = TRUE, deparse_cat = FALSE) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n"); 
"analyticDF_time2event.NA.rmAllNA |> select_if(is.logical) |> summary()" |> env1$f$f_CodeText.echo(Execute = TRUE, deparse_cat = FALSE) |> system.time() |> round(3) |> unclass() |> deparse() |> cat("\n")
...
if(exists("MetaData")) {
    ...
    if(!identical(.MetaData0, MetaData)) {
        ...
        cat("'git add -f ",shQuote(.path.file),"' |> system(intern=TRUE)  \n", sep="")
        cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
