...
# cat(" getwd() == "); dput(getwd()) #                                      ...201
# if (getwd() != .path4write) warning("getwd() != .path4write  == ") else cat(" getwd() == .path4write == "); dput(.path4write)  #      ...229
# @@ REFERENCES)                                                            ...234
# @@ DATA) example                                                          ...243
# @@ START) dev                                                             ...263
# @@ SOURCE)                                                                ...298
# @@ START) function                                                        ...340
# @@ MetaData) Read & Check                                                 ...389
#@@ DATA) Read & Check                                                      ...459
# @@ ANALYSIS) (Breif) byVar =                                              ...625
# @@ DATA) mutate()                                                         ...631
# @@ DATA) filter() -> New DS                                               ...662
# @@ DATA) select(matches(VarName.suffix.regex))                            ...695
# @@ ANALYSIS) byVar =                                                      ...709
