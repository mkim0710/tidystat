...
# #### env1\$env.internal\$f_path.df_dirs_recursive.df_files() ----
# sourcename = "f_path.df_dirs_recursive.df_files"; subpath=""; subpath.filename.source.r = paste0(subpath,ifelse(subpath=="","","/"),sourcename,".source.r"); suppressPackageStartupMessages(source( file.path(env1$path$source_base,subpath.filename.source.r) ))
# env1$path$df_dirs_recursive.df_files = env1$env.internal$f_path.df_dirs_recursive.df_files(input_path=".", print.message=FALSE)
# env1$path$print_tree_path = env1$path$df_dirs_recursive.df_files |> filter(path.level <= 2) |> 
#     dplyr::select(print_tree_path) |> unlist() |> paste(collapse="") 
# # env1$path$print_tree_path |> cat()
# env1$path$print_tree_path_files.codes = env1$path$df_dirs_recursive.df_files |> filter(path.level <= 2) |> 
#     dplyr::select(print_tree_path_files.codes) |> unlist() |> paste(collapse="") 
# # env1$path$print_tree_path_files.codes |> cat()
# env1$path$print_tree_path_files.data = env1$path$df_dirs_recursive.df_files |> filter(path.level <= 2) |> 
...
# #### env1\$f_path.size_files() ----
# sourcename = "f_path.size_files"; subpath=""; subpath.filename.source.r = paste0(subpath,ifelse(subpath=="","","/"),sourcename,".source.r"); suppressPackageStartupMessages(source( file.path(env1$path$source_base,subpath.filename.source.r) ))
...
subpath.filename.source.r = paste0(subpath,ifelse(subpath=="","","/"),sourcename,".source.r"); suppressPackageStartupMessages(source( file.path(env1$path$source_base,subpath.filename.source.r) ))
