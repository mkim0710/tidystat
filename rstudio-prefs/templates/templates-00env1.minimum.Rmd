...
subpath.filename.source.r = paste0(subpath,ifelse(subpath=="","","/"),sourcename); suppressPackageStartupMessages(source( file.path(env1$path$source_base,subpath.filename.source.r) ))
...
get(DataSetName)[intersect(varname4ID, colnames(get(DataSetName)))] |> env1$data.NotNA_p_df()
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n"); 
cat(" > ",DataSetName,".Date",".NA"," |> env1$data.NotNA_p_df()","  \n", sep=""); env1$data.NotNA_p_df(get(paste0(DataSetName,".Date",".NA")))
```
