...
#     if(.tmp$SourceFileName.ext != basename(env1$path$CurrentSource.path.filename.ext %>% {paste0(env1$path$path1,"/",.)})) {
#         if(!file.exists(.tmp$SourceFileName.ext)) file.create(.tmp$SourceFileName.ext)
#         file.edit(.tmp$SourceFileName.ext)
