...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
assign( paste0(DataSetName2,".NA"), get(DataSetName2) |> mutate_if(is.factor, as.character) )
...
assign( paste0(DataSetName2,".NA",".rmAllNA"), get(paste0(DataSetName2,".NA")) |> select_if(function(vec) !all(is.na(vec))) )
