...
assign( paste0(DataSetName,".Date",".NA"), get(paste0(DataSetName,".Date")) |> mutate_if(is.factor, as.character) |> mutate_if(is.character, na_if, "") |> mutate_if(is.character, na_if, "N/A") |> mutate_if(is.character, na_if, "NA") |> as_tibble() )
...
cat("    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%    \n")
cat(" > ",DataSetName,".Date",".NA"," |> env1$f_df.NotNA_p_df()","  \n", sep=""); env1$f_df.NotNA_p_df(get(paste0(DataSetName,".Date",".NA")))
```
...
for (varname in vec_candidate4ID) {if(varname %in% names(get(paste0(DataSetName,".Date",".NA",".rmAllNA")))) cat(" n_distinct(",paste0(DataSetName,".Date",".NA",".rmAllNA"),"$",varname,") == ",n_distinct(get(paste0(DataSetName,".Date",".NA",".rmAllNA"))[[varname]]),"  \n", sep="")}
