...
if(file.exists(file.path(.path4read, "MetaData.rds"))) { 
    MetaData = read_rds(file.path(.path4write, "MetaData.rds")) 
} else {
...
if(!identical(.MetaData0, MetaData)) {
    cat("    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    \n")
    cat('env1$env.internal$f_filename.ext.createBackup(backup_from_path.filename.ext = "',file.path(.path4read, "MetaData.rds"),'", .backup_to_path="-backup", timeFormat="%y%m%d_%H", overwrite=TRUE)', "  ;  ", sep="")
    cat('MetaData |> write_rds("',file.path(env1$path$path1, "MetaData.rds"),'", compress = "xz") |> system.time()', "  \n", sep="")
