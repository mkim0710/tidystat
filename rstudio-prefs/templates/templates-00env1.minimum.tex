...
\NormalTok{Time difference of }\FloatTok{12.90238}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.90708}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.91135}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.91526}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Backup file created: D:/OneDrive/[][Rproject]/-backup/notebook-240728_2340.Rmd
