...
\NormalTok{Time difference of }\FloatTok{10.21599}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{10.22043}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{10.22466}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{10.22849}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Backup file created: D:/OneDrive/[][Rproject]/-backup/notebook-240729_0233.Rmd
