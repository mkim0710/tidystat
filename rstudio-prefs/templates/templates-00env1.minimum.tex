...
List of 19
 ...
 $ CurrentSource.path.filename.ext : chr "templates-00env1.minimum.Rmd"
 $ RTemplate.filename.ext          : chr "notebook.Rmd"
 $ MyTemplate.filename.ext         : chr "templates-00env1.minimum.Rmd"
 $ CurrentSource.path.filename.pdf : chr "templates-00env1.minimum.pdf"
 $ CurrentSource.path.filename.html: chr "templates-00env1.minimum.html"
\end{verbatim}
...
\NormalTok{Time difference of }\FloatTok{0.005553007}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{()}\SpecialCharTok{{-}}\NormalTok{t0}
\NormalTok{Time difference of }\FloatTok{0.003899097}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{()}\SpecialCharTok{{-}}\NormalTok{t0}
\NormalTok{Time difference of }\FloatTok{0.003739119}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{()}\SpecialCharTok{{-}}\NormalTok{t0}
\NormalTok{Time difference of }\FloatTok{0.003535032}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Backup file created: D:/OneDrive/[][Rproject]/-backup/notebook-240717_0017.Rmd
