...
\NormalTok{DataSetName2.NA.rmAllNA.lbl_pending.fct }\OtherTok{=} \FunctionTok{paste0}\NormalTok{(DataSetName2,}\StringTok{".NA"}\NormalTok{,}\StringTok{".rmAllNA"}\NormalTok{,}\StringTok{".fct"}\NormalTok{); }
\StringTok{"assign( DataSetName2.NA.rmAllNA.lbl_pending.fct, get(DataSetName2.NA.rmAllNA) |\textgreater{} mutate\_if(is.character, as.factor) , envir = .GlobalEnv)"} \SpecialCharTok{|\textgreater{}}\NormalTok{ env1}\SpecialCharTok{$}\NormalTok{f}\SpecialCharTok{$}\FunctionTok{f\_CodeText.echo}\NormalTok{(}\AttributeTok{Execute =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{deparse\_cat =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{LinePrefix4CodeText =} \StringTok{"\textgreater{} "}\NormalTok{, }\AttributeTok{LinePrefix4Output =} \StringTok{""}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{system.time}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{3}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{unclass}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{deparse}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\SpecialCharTok{\textgreater{}} \FunctionTok{assign}\NormalTok{( }\StringTok{"analyticDF\_time2event.NA.rmAllNA.lbl_pending.fct"}\NormalTok{, analyticDF\_time2event.NA.rmAllNA }\SpecialCharTok{|\textgreater{}} \FunctionTok{mutate\_if}\NormalTok{(is.character, as.factor) , }\AttributeTok{envir =}\NormalTok{ .GlobalEnv)  }
...
\begin{Shaded}
\begin{Highlighting}[]
\StringTok{"get(DataSetName2.NA.rmAllNA.lbl_pending.fct) |\textgreater{} select\_if(is.factor) |\textgreater{} summary()"} \SpecialCharTok{|\textgreater{}}\NormalTok{ env1}\SpecialCharTok{$}\NormalTok{f}\SpecialCharTok{$}\FunctionTok{f\_CodeText.echo}\NormalTok{(}\AttributeTok{Execute =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{deparse\_cat =} \ConstantTok{FALSE}\NormalTok{, }\AttributeTok{LinePrefix4CodeText =} \StringTok{"\textgreater{} "}\NormalTok{, }\AttributeTok{LinePrefix4Output =} \StringTok{""}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{system.time}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{round}\NormalTok{(}\DecValTok{3}\NormalTok{) }\SpecialCharTok{|\textgreater{}} \FunctionTok{unclass}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{deparse}\NormalTok{() }\SpecialCharTok{|\textgreater{}} \FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\SpecialCharTok{\textgreater{}}\NormalTok{ analyticDF\_time2event.NA.rmAllNA.lbl_pending.fct }\SpecialCharTok{|\textgreater{}} \FunctionTok{select\_if}\NormalTok{(is.factor) }\SpecialCharTok{|\textgreater{}} \FunctionTok{summary}\NormalTok{()  }
\NormalTok{    Group    }
