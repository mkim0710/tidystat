...
\NormalTok{Time difference of }\FloatTok{0.005362988}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{0.003814936}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{0.009616137}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{0.003695965}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Backup file created: D:/OneDrive/[][Rproject]/-backup/notebook-240805_0037.Rmd
