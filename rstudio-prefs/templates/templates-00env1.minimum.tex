...
\NormalTok{Time difference of }\FloatTok{12.56054}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.56485}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.57032}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{Sys.time}\NormalTok{() }\SpecialCharTok{{-}}\NormalTok{ .t0}
\NormalTok{Time difference of }\FloatTok{12.57424}\NormalTok{ secs}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
Backup file created: D:/OneDrive/[][Rproject]/-backup/notebook-240728_2234.Rmd
