...
file.edit(paste0(env.custom$path$path1,"/","[Working Files List].r")); file.edit(env.custom$path$CurrentSource.path.filename.ext)
...
# env.custom$path$df_dirs_recursive.df_files = env.custom$env.internal$f_path.df_dirs_recursive.df_files(input_path=".", print.message=FALSE)
...
#     env.custom$tmp$SourceFileName.ext = paste0(SourceFileBaseName,"-",basename(env.custom$path$path1),".Rmd");
...
env.custom$path$RTemplate.filename.ext = "notebook.Rmd"
env.custom$path$MyTemplate.filename.ext = "templates-00env.custom.minimum.Rmd"
env.custom$path$CurrentSource.path.filename.ext=rstudioapi::getSourceEditorContext()$path; 
#|%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%|#  
...
if (.Platform$OS.type == "windows") {
    if(basename(env.custom$path$CurrentSource.path.filename.ext) == env.custom$path$MyTemplate.filename.ext) {
    ...
    # if(!file.exists(file.path(path4APPDATA_RStudio, "templates", env.custom$path$RTemplate.filename.ext))) file.create(file.path(path4APPDATA_RStudio, "templates", env.custom$path$MyTemplate.filename.ext)); file.edit(file.path(path4APPDATA_RStudio, "templates", env.custom$path$RTemplate.filename.ext))
} 
```
