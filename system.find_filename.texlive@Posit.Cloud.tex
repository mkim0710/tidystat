...
\StringTok{"echo $PATH"} \SpecialCharTok{|\textgreater{}}
    \FunctionTok{system}\NormalTok{(}\AttributeTok{intern =} \ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
    \FunctionTok{cat}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\SpecialCharTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{sbin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{sbin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{sbin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{games}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{local}\SpecialCharTok{/}\NormalTok{games}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{snap}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\DecValTok{4}\NormalTok{.}\FloatTok{3.3}\SpecialCharTok{/}\NormalTok{lib}\SpecialCharTok{/}\NormalTok{R}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{home}\SpecialCharTok{/}\NormalTok{r149319}\SpecialCharTok{/}\NormalTok{.local}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{cloud}\SpecialCharTok{/}\NormalTok{python}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{opt}\SpecialCharTok{/}\NormalTok{quarto}\SpecialCharTok{/}\DecValTok{1}\NormalTok{.}\FloatTok{4.550}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{lib}\SpecialCharTok{/}\NormalTok{rstudio}\SpecialCharTok{{-}}\NormalTok{server}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{postback}\SpecialCharTok{:}\ErrorTok{/}\NormalTok{usr}\SpecialCharTok{/}\NormalTok{lib}\SpecialCharTok{/}\NormalTok{rstudio}\SpecialCharTok{{-}}\NormalTok{server}\SpecialCharTok{/}\NormalTok{bin}\SpecialCharTok{/}\NormalTok{postback }
\end{Highlighting}
\end{Shaded}
