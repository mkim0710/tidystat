...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) install.packages.if_not_already_installed  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "install.packages.if_not_already_installed")
...
.tmp$env1_subenv_name = "f"; env1$env.internal$f_function.load2env.internal(function_object = .tmp$object, function_name = .tmp$objectname, env1_subenv_name = .tmp$env1_subenv_name, show_packageStartupMessage = .tmp$env1_subenv_name == "f", RELOAD_FUNCTION = isTRUE(getOption("RELOAD_FUNCTION"))||isTRUE(getOption("DEVMODE")), runLoadedFunction = FALSE)
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) rstudioapi.getSourceEditorContext.path_FileNameExt  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "rstudioapi.getSourceEditorContext.path_FileNameExt")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) CurrentSourceEditorContext.path_FileNameExt  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "CurrentSourceEditorContext.path_FileNameExt")
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
.tmp$env1_subenv_name = "f"
.tmp$objectname = "setwd.as_SourceEditorContext"
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function() {
    SourceEditorContext.path_FileNameExt = rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/",mustWork=NA)
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(..., collapse = "/") {  
    ...
    # c(...) %>% {.[.!=""]} |> paste0(collapse = collapse)  
    # c(...) %>% {.[nzchar(.)]} |> paste0(collapse = collapse)  
...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## :: getSourceEditorContext.update_LastSourceEditorContext.path_FileNameExt =  ----  
.tmp$env1_subenv_name = "env.internal.attach"
.tmp$objectname = "getSourceEditorContext.update_LastSourceEditorContext.path_FileNameExt"
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(
    ...
    if(is.null(env1$path$LastSourceEditorContext.path_FileNameExt) || is.na(env1$path$LastSourceEditorContext.path_FileNameExt) || env1$path$LastSourceEditorContext.path_FileNameExt == "") overwrite = TRUE
    ...
    if (check_rstudioapi) {
        if (requireNamespace("rstudioapi")) {
            ...
            if (rstudioapi::isAvailable()) {
                ...
                env1$path$LastSourceEditorContext.path_FileNameExt = NA
                return(invisible())
            }
    ...
    if(overwrite) {
        # env1$path$LastSourceEditorContext.path_FileNameExt = getwd() |> normalizePath(winslash="/",mustWork=NA) |> str_replace(fixed(env1$path$path1|>normalizePath(winslash="/",mustWork=NA)), "") |> str_replace("^/", "")
        ...
        env1$path$LastSourceEditorContext.path = env1$path$LastSourceEditorContext.path_FileNameExt |> dirname()
        
        # cat(LinePrefix4CodeText, "env1$path$LastSourceEditorContext.path_FileNameExt == ", deparse(env1$path$LastSourceEditorContext.path_FileNameExt), "  \n", sep="")
        .CodeText2Print = 'env1$path$LastSourceEditorContext.path_FileNameExt'; (ifelse(is.null(eval(parse(text=.CodeText2Print))), paste0("is.null(",.CodeText2Print,") == TRUE"), paste0(.CodeText2Print," == ",deparse(eval(parse(text=.CodeText2Print)))))) %>% {cat(LinePrefix4CodeText, ., "  \n", sep = "")}
        ...
        env1$f$f_CodeTexts.parse.eval.identical("env1$path$LastSourceEditorContext.path_FileNameExt", 'rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/",mustWork=NA) |> str_replace(fixed(env1$path$path1|>normalizePath(winslash="/",mustWork=NA)), "") |> str_replace("^/", "")')
    }
    return(invisible())
}
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) update_LastSourceEditorContext.path_FileNameExt  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "update_LastSourceEditorContext.path_FileNameExt")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) setLastSourceEditorContext.path_FileNameExt  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "setLastSourceEditorContext.path_FileNameExt")
##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++  
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(
    ...
    input_path.list.files.file.info = 
        ...
        transmute(
            ...
            , FileNameExt = basename(path_file)
            , FileName = env1$env.internal$f_vec_path.vec_FileName_sans_ext_extended(FileNameExt)
            , ext = env1$env.internal$f_vec_path.vec_ext_extended(FileNameExt) |> as.factor()
            , size = size
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(
    ...
    vec_colnames_to_show = c("path.relative", "FileNameExt", "ext", "size_MiB", "isdir", "ModifiedDate")
    vec_col_index_to_hide = which(!colnames(DS) %in% vec_colnames_to_show)
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(
    ...
    env1$f$f_list_df.write_xlsx_table(list_df = c(list_df_ProjectDocuments, list_df), output_FileName.xlsx = output_FileName.xlsx, vec_colnames_to_show = c("path.relative", "FileNameExt", "ext", "size_MiB", "isdir", "ModifiedDate"), first_active_row = 2, first_active_col = 5, overwrite = overwrite, xls.open_or_browseURL = xls.open_or_browseURL)
...
# Rdev/00_base_program/002_base_encoding_RegEx/f_path.df_FileNameExt_extended.dev.Rmd
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(input_path, vec_RegEx4ext_extended = c("\\.[^.]*\\.[gx]z$", "\\.nb\\.html$")) {
    ...
    input_FileNameExt = basename(input_path)
    input_ext = 
        map2_chr(
            input_FileNameExt %>% str_extract(vec_RegEx4ext_extended %>% paste0(collapse = "|")) %>% str_remove("^\\."), 
            input_FileNameExt %>% tools::file_ext(), 
            function(x, y) ifelse(is.na(x), y, x)
        )
    input_FileName = str_remove(input_FileNameExt, paste0("\\.", input_ext, "$"))
    input_FileName
}
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) extract_FileNameExt_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "extract_FileNameExt_extendedVec")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) FileName.extract_ext_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "FileName.extract_ext_extendedVec")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) file_path_sans_ext.ext_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "file_path_sans_ext.ext_extendedVec")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) path_FileNameExt_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "path_FileNameExt_extendedVec")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) FileNameExt_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "FileNameExt_extendedVec")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) file_ext_extendedVec  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "file_ext_extendedVec")
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## :: f_path.df_FileNameExt_extended =  ----  
# Rdev/00_base_program/002_base_encoding_RegEx/f_path.df_FileNameExt_extended.dev.Rmd
.tmp$env1_subenv_name = "f"
.tmp$objectname = "f_path.df_FileNameExt_extended"
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(input_path, vec_RegEx4ext_extended = c("\\.[^.]*\\.[gx]z$", "\\.nb\\.html$")) {
...
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) extract_FileNameExt_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "extract_FileNameExt_extendedDf")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) FileName.extract_ext_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "FileName.extract_ext_extendedDf")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) file_path_sans_ext.ext_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "file_path_sans_ext.ext_extendedDf")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) path_FileNameExt_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "path_FileNameExt_extendedDf")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) FileNameExt_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "FileNameExt_extendedDf")
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
#### (ALIAS) file_ext_extendedDf  ----  
env1$env.internal.attach$f_env1_subenv_objectname.set_ALIAS(subenv_name4object = .tmp$env1_subenv_name, objectname = .tmp$objectname, subenv_name4ALIAS = "env.internal.attach", ALIASname = "file_ext_extendedDf")
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(path = ".", gsub.pattern_from, gsub.replacement_to, full.names = TRUE, recursive = FALSE, move_to_renamed_path = FALSE, execute = FALSE) {
    ...
    old_FileNameExt = basename(old_path_files)
    old_path = ifelse(old_path_files == basename(old_path_files), "", dirname(old_path_files))
    new_FileNameExt = gsub(gsub.pattern_from, gsub.replacement_to, old_FileNameExt)
    new_path_files <- ifelse(old_path == "", "", paste0(old_path, "/")) |> paste0(new_FileNameExt)
...
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## :: f_FileNameExt.append_suffix =  ----  
# Rdev/00_base_program/002_base_encoding_RegEx/f_FileNameExt.append_suffix.dev.r
.tmp$objectname = "f_FileNameExt.append_suffix"
.tmp$object <- function(path_FileNameExt, append_suffix, compression = TRUE, VERBOSE = getOption("verbose")) {
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(path_file, return2LastSourceEditorContext = FALSE, LastSourceEditorContex_as_in_env1_path = FALSE, VERBOSE = getOption("verbose")) {
    ...
    if(return2LastSourceEditorContext) {
        ...
        # .GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt = ifelse(  
        ...
        if(LastSourceEditorContex_as_in_env1_path) {
            .GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt = env1$path$LastSourceEditorContext.path_FileNameExt 
        } else {
            .GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt = rstudioapi::getSourceEditorContext()$path |> normalizePath(winslash="/",mustWork=NA)    # Caution) not a relative path~!  
        };  
        if(VERBOSE) message(paste0("[VERBOSE] .tmp$LastSourceEditorContext.path_FileNameExt == ", .tmp$LastSourceEditorContext.path_FileNameExt))  
    }
    ...
    if(return2LastSourceEditorContext) {
        if(VERBOSE) message(paste0("[VERBOSE] env1$f$f_object.is_not_null.nor_na.nor_blank(.GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt) == ", env1$f$f_object.is_not_null.nor_na.nor_blank(.GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt, show_warning  = FALSE))) 
        if(env1$f$f_object.is_not_null.nor_na.nor_blank(.GlobalEnv$.tmp$LastSourceEditorContext.path_FileNameExt)) .tmp$LastSourceEditorContext.path_FileNameExt %>% {.[file.exists(.)]} |> file.edit()
    }
}
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
.tmp$env1_subenv_name = "env.internal.attach"
.tmp$objectname = "f_URL.browse_in_edge_app"
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(URL) {
...
# R/fChr-fFilePath.BACKUP-source.R
#_________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ f_git ----  
# R/fChr-fFilePath.git-source.R
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ f_file.read ----  
# R/fChr-fFilePath.read-source.R
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ f_file.save ----  
# R/fChr-fFilePath.save-source.R
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ f_file.update ----  
...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(.RelativeSubPath_FileName.source.r = if(!is.null(.RelativeSubPath) && !is.null(.FileName.source.r)) list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)} else NULL, .RelativeSubPath = NULL, .FileName.source.r = NULL, RELOAD_FUNCTION = isTRUE(getOption("RELOAD_FUNCTION"))||isTRUE(getOption("DEVMODE")), DEBUGMODE = isTRUE(getOption("DEBUGMODE"))) {
    ...
    # List of 4
    #  $ .RelativeSubPath_FileName.source.r: chr "Rdev/10_import_clean_datatype/16_categorical_labelled/f_CodeBook_DS.lbl.source.r"
    ...
    if(RELOAD_FUNCTION || !.FileName.source.r %in% names(.GlobalEnv$env1$source)) {  
        ...
        #@ DEBUG) .RelativeSubPath_FileName.source.r is given as the full path or URL
        # > .RelativeSubPath_FileName.source.r = "https://raw.githubusercontent.com/mkim0710/tidystat/master/env1$env.internal.source.r"
        # > .RelativeSubPath_FileName.source.r %>% relative_path()
        ...
        .source_base.RelativeSubPath_FileName.source.r = 
            if (file.exists(.RelativeSubPath_FileName.source.r)) {
                .RelativeSubPath_FileName.source.r
            } else if (file.exists(paste0(env1$path$source_base_local, "/", .RelativeSubPath_FileName.source.r))) {
                paste0(env1$path$source_base_local, "/", .RelativeSubPath_FileName.source.r)
            } else if (  grepl("^http", .RelativeSubPath_FileName.source.r, ignore.case = TRUE) || 
                         grepl("githubusercontent\\.com", .RelativeSubPath_FileName.source.r, ignore.case = TRUE) ||
                         grepl("github\\.com", .RelativeSubPath_FileName.source.r, ignore.case = TRUE)  ) {
                .RelativeSubPath_FileName.source.r
            } else {
                paste0(env1$path$source_base_github, "/", .RelativeSubPath_FileName.source.r)
            }
        .GlobalEnv$env1$source[[.FileName.source.r]] = .source_base.RelativeSubPath_FileName.source.r
        message('> source("',.source_base.RelativeSubPath_FileName.source.r,'")');
        source(.source_base.RelativeSubPath_FileName.source.r)
...
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fSys-fEnv" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fSys-fEnv" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
...
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath-fURL" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath-fURL" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.open.edit" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.open.edit" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.BACKUP" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.BACKUP" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.git" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.git" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.read" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.read" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.save" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.save" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fFilePath.update" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fFilePath.update" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "fChr-fRegEx" |> paste0("-source.R") |> source() ----  
.FileName.source.r = "fChr-fRegEx" |> paste0("-source.R"); .RelativeSubPath=r"(R)"|>str_replace_all("\\\\","/"); 
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
...
##________________________________________________________________________________  
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
## @ "help-show" |> paste0("-source.R") |> source() ----  
.RelativeSubPath = r"(R)" |> str_replace_all("\\\\","/")  
.FileName.source.r = "help-show" |> paste0("-source.R")
env1$f$f_sourcePath.execute_if_not_sourced(.RelativeSubPath_FileName.source.r = list(.RelativeSubPath, .FileName.source.r) %>% {.[nzchar(.)]} %>% c(fsep = "/") %>% {do.call(file.path, .)})
##%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
#### \$ list_path_hierarchy  =======  
.max_hierarchy = 5
