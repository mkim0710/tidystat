...
env1[[.tmp$env1_subenv_name]][[.tmp$objectname]] = function(
    ...
    if(browseTXT) env1$env.internal.attach$f_file.browse_in_edge(output_path_file) else paste0("env1$env.internal.attach$f_file.browse_in_edge(", deparse(output_path_file), ")  \n") |> message(appendLF = FALSE)
